    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <form action="<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $config['appRoot'] . '/'; ?>document_sign_sow/upload_files" method="post" enctype="multipart/form-data">
        <ul class="nav navbar-nav">
          ...
          <li class="active"><a href="#"><input type="file" name="file" id="file" required ></a></li>
          <li class="active"><a href="#"><input type="submit" value="upload" style="color:black" name="Upload"></a></li>
