                    ...
                    <table id="user-profile-booking-table" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
						...
						while($dd = mysqli_fetch_array($details)){
                            ...
                            <tr>
                                ...
                                ?>
                                <td>
                                    <a href="#user-booking-details<?php  echo $dd['order_id'];?>" data-toggle="modal" data-target="#user-booking-details<?php  echo $dd['order_id'];?>" class="ct-my-booking-user btn btn-info myappointment_popup"><i class="fa fa-eye"></i><?php echo $label_language_values['my_appointments'];?></a>
                                </td>
                                <td>
										...
										<table id="user-all-bookings-details" class="table table-striped table-bordered responsive nowrap" cellspacing="0" width="100%">
											...
											<tr>
												...
												<td>
													...
													{
														if($dd['booking_status'] == 'A' || $dd['booking_status'] == 'C'){
