...
$extensionslist = "";//$setting->get_contents('https://skymoonlabs.com/cleanto/extensions-assets/extensions_list.php?'.time());
		...
		<div class="container-fluid mt-20 mb-20">
			<div class="container">
				...
				if(isset($arr_extensionslist->extensions)){
					if(sizeof($arr_extensionslist->extensions)>0){
						$i = 0;
									...
									<div class="addon_box">
										...
										<div class="col-xs-9">
											...
											<?php 
												...
												}else if((!file_exists(dirname(dirname(__FILE__)).'/extension/'.$extensions->extension) && file_exists(dirname(dirname(__FILE__)).'/extension/'.$extensions->extension.'-'.$extensions->version.'.zip')) && $setting->get_option($extensions->purchase_option_name) == 'Y'){
													if($extensions->free_extention_class_name != ''){
														?>
														<h4><i class="fa fa-check-square 7" aria-hidden="true"></i> <a href="javascript:void(0);" class="<?php echo $extensions->free_extention_class_name; ?>" data-installed_version="<?php echo $setting->get_option($extensions->version_option_name); ?>" data-update_version="<?php echo $extensions->version; ?>" data-redirect_to="<?php echo $extensions->after_installed_redirect_to; ?>" data-extension="<?php echo $extensions->extension; ?>" data-purchase_option='<?php echo $extensions->purchase_option_name; ?>' data-version_option='<?php echo $extensions->version_option_name; ?>'><?php echo $extensions->Activate_Feature_label_text; ?></a></h4>
														<?php 
												...
												}else if(!file_exists(dirname(dirname(__FILE__)).'/extension/'.$extensions->extension) && file_exists(dirname(dirname(__FILE__)).'/extension/'.$extensions->extension.'-'.$extensions->version.'.zip') && $setting->get_option($extensions->purchase_option_name) == 'N'){
													if($extensions->free_extention_class_name != ''){
														?>
														<h4><i class="fa fa-check-square 7" aria-hidden="true"></i> <a href="javascript:void(0);" class="<?php echo $extensions->free_extention_class_name; ?>" data-installed_version="<?php echo $setting->get_option($extensions->version_option_name); ?>" data-update_version="<?php echo $extensions->version; ?>" data-redirect_to="<?php echo $extensions->after_installed_redirect_to; ?>" data-extension="<?php echo $extensions->extension; ?>" data-purchase_option='<?php echo $extensions->purchase_option_name; ?>' data-version_option='<?php echo $extensions->version_option_name; ?>'><?php echo $extensions->Activate_Feature_label_text; ?></a></h4>
														<?php 
												...
												}else if(file_exists(dirname(dirname(__FILE__)).'/extension/'.$extensions->extension) && $setting->get_option($extensions->version_option_name) != '' && ($setting->get_option($extensions->version_option_name) < $extensions->version)){
													if($extensions->free_extention_class_name != ''){
														?>
												...
												}else if(file_exists(dirname(dirname(__FILE__)).'/extension/'.$extensions->extension) && $setting->get_option($extensions->purchase_option_name) == 'Y'){
													?>
