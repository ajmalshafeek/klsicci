...
$first_step->conn=$conn;
	...
	if(!is_numeric(strpos($decrypt_code,'#'))) {
		echo "Wrong URL"; die;
	}
...
<html lang="en">
    <head>
		...
		<script type="text/javascript" src="<?php echo BASE_URL; ?>/assets/js/client_forgot_password.js"></script>  
							...
							<div class="tab-content">
								<form id="reset_new_passwd" method="post">
									...
									<h1 class="forget-password"><?php echo $label_language_values['reset_password'];?></h1>
										...
										<label class="forget_pass_correct" style="display: none;"></label>
										<label class="forget_pass_incorrect" style="display: none;"></label>
																
									<?php  } 	if($current_time > $url_time){	?>
										<h4 class="txt-danger" style="display:block;"><?php echo $label_language_values['your_reset_password_link_expired'];?></h4>									
									<?php 
										}else{
									?>
									<div class="clearfix"> 
