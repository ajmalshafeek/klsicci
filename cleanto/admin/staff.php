...
<div id="cta-staff-panel" class="panel tab-content np">
	<div class="panel panel-default">
		<div class="panel-heading">
			<h1 class="panel-title"><?php echo $label_language_values['staff_details_add_new_and_manage_staff_payments']; ?></h1>
		</div>
			...
			<div class="tab-content">
					...
					<div id="accordion" class="panel-group">
						<div class="ct-staff-list col-md-3 col-sm-4 col-xs-12 col-lg-3">
							<div class="ct-staff-container">
								<h3><?php echo $label_language_values['staff_members'];?> <span>(<?php echo $objadmin->countall_staff();?>)</span>
								<!-- hide add staff ?
									...
									<?php  
										...
										while($arr_staff = mysqli_fetch_array($all_staff)){
											...
											<li class="staff-list br-2 staff_click staff_<?php  echo $trigger;?> staff_c_<?php  echo $arr_staff['id'];?>" id="" data-id = "<?php echo $arr_staff['id'];?>">
												...
												<span class="ct-staff-image"><img class="ct-staf-img-small small-staff-image<?php  echo $arr_staff['id'];?>" src="<?php echo $imagepath;?>" /></span>
				...
				<div id="staff-booking-payments" class="tab-pane fade">
					<div class="panel-body pall-15">
						<h3><?php echo $label_language_values['staff_booking_details_and_payment']; ?></h3>
						<div id="accordion" class="panel-group">
							<div class="ct-calendar-top-bar">
								<div class="col-md-4 col-sm-6 col-xs-12 col-lg-4 mb-10">
									<label><?php echo $label_language_values['select_option_to_show_bookings']; ?></label>
								...
								<div class="col-md-3 col-sm-6 col-xs-6 col-lg-3 mb-10">
									...
									<select name="" class="selectpicker get_serid_for_staff_pymnt" data-size="10" style="display: none;" data-live-search="true">
										<option value="all" selected><?php echo $label_language_values['all_services']; ?></option>
										<?php 
										$readall_staff_pymt_ser = $staff_commision->readall_staff_pymt_ser();
										while($allser = mysqli_fetch_array($readall_staff_pymt_ser)){
											?>
											<option value="<?php echo $allser['id']; ?>"><?php echo $allser['title']; ?></option>
											<?php 
										}
										?>
									</select>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<table class="form-horizontal" cellspacing="0">
					...
					<tr class="form-field form-required">
						<td><label for="ab-newstaff-fullname"><?php echo $label_language_values['name'];?></label></td>
						<td><input type="text" class="form-control staff_name" id="staff_name" name="staff_name" required="required" /></td>
					</tr>
					<tr class="form-field form-required">
						<td><label for="ab-newstaff-fullname"><?php echo $label_language_values['email'];?></label></td>
						<td><input type="email" class="form-control staff_email" id="staff_email" name="staff_email" required="required" /></td>
					</tr>
					<tr class="form-field form-required">
						<td><label for="staff_pass"><?php echo "Password";?></label></td>
			...
			<div class="modal-footer">
				...
				<button type="button" class="btn btn-success save_staff"><?php echo $label_language_values['create'];?></button>
			</div>
		</div>
	</div>
</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content ">
			...
			<div class="modal-body">
				...
				<span class="error hide comission_error_display"><?php   echo $label_language_values['commission_amount_should_not_be_greater_then_order_amount']; ?></span>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default close_spc_popup" data-dismiss="modal"><?php echo $label_language_values['close'];?></button>
