...
$setting->conn = $conn;
$gettimeformat=$setting->get_option('ct_time_format');/*CHECK FOR VC AND PARKING STATUS*/$global_vc_status = $setting->get_option('ct_vc_status');$global_p_status = $setting->get_option('ct_p_status');/*CHECK FOR VC AND PARKING STATUS END*/
?>
						...
						<div class="col-xs-12 np ct-footer-popup-btn text-center">
							...
							<div class="fln-mrat-dib">
								<span class="col-xs-4 np ct-w-32 myconfirmclass">
									<a id="ct-reschedual-appointment" class="btn btn-link ct-small-btn rescedual_book ct-reschedual-appointment-cal" data-id="" title="edit" ><i class="fa fa-pencil-square-o fa-2x"></i><br />Edit</a>
								</span>
								<span class="col-xs-4 np ct-w-32 myconfirmclass">
									<a id="ct-confirm-appointment" class="btn btn-link ct-small-btn confirm_book ct-confirm-appointment-cal" data-id="" title="<?php  echo $label_language_values['confirm_appointment'];?>"><i class="fa fa-thumbs-up fa-2x"></i><br /><?php  echo $label_language_values['confirm'];?></a>
								</span>	
