...
function gc_settings_menu_content(){
  ...
  `gc_id` varchar(500) NOT NULL,
  `gc_status` enum('Y','N') NOT NULL,
  `gc_token` text NOT NULL,
  `gc_status_configure` enum('Y','N') NOT NULL,
  `gc_status_sync_configure` enum('Y','N') NOT NULL,
				...
				<form id='ct-gc-settings' method='post' type='' class='ct-labels-settings' >
                    <div class='panel panel-default'>
                        <div class='panel-heading cta-top-right'>
                            ...
                            <span class='pull-right cta-setting-fix-btn'> <a class='btn btn-success save_google_calender_settings' type='submit'>".$label_language_values['save_setting']."</a></span>
                        </div>
...
function gc_staff_settings_menu_content(){
	...
	$menu_content .= "<div class='tab-pane fade in' id='google-calendar-settings'>
								...
								<table class='form-inline ct-common-table'>
									<tbody>
											...
											<td>
												<div class='form-group'>
													<label class='ctoggle-gc-status' for='ct-gc-status'>
														<input class='cta-toggle-checkbox' data-toggle='toggle' data-size='small' type='checkbox'";
														if($setting->get_staff_option('gc_status',$_SESSION['staffid'])=='Y'){
															$menu_content .= 'checked';
														}
															$menu_content .= " id='ct-gc-status' data-onstyle='success' data-offstyle='danger' />
													</label>
										...
										<tr>
											...
											<td>
												<div class='form-group'>
													<input type='text' size='50' class='form-control ct_gc_id' name='ct_gc_id v_c' data-names='ct_gc_id' value='".$setting->get_staff_option('gc_id',$_SESSION['staffid'])."'>
													<a class='ct-tooltip-link' href='#' data-toggle='tooltip' title='".$label_language_values['Your_Google_calendar_id_where_you_need_to_get_alerts_its_normaly_your_Gmail_ID']."'><i class='fa fa-info-circle fa-lg'></i></a>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class='form-group'>
													<input type='text' size='50' class='form-control ct_gc_client_id' name='ct_gc_client_id v_c' data-names='ct_gc_client_id' value='".$setting->get_staff_option('gc_client_id',$_SESSION['staffid'])."'>
													<a class='ct-tooltip-link' href='#' data-toggle='tooltip' title='".$label_language_values['You_can_get_your_client_ID_from_your_Google_Calendar_Console']."'><i class='fa fa-info-circle fa-lg'></i></a>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class='form-group'>
													<input type='text' size='50' class='form-control ct_gc_client_secret' name='ct_gc_client_secret v_c' data-names='ct_gc_client_secret' value='".$setting->get_staff_option('gc_client_secret',$_SESSION['staffid'])."'>
													<a class='ct-tooltip-link' href='#' data-toggle='tooltip' title='".$label_language_values['You_can_get_your_client_secret_from_your_Google_Calendar_Console']."'><i class='fa fa-info-circle fa-lg'></i></a>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class='form-group'>
													<input type='text' size='50' class='form-control ct_gc_frontend_url' name='ct_gc_frontend_url v_c' data-names='ct_gc_frontend_url' value='".$setting->get_staff_option('gc_frontend_url',$_SESSION['staffid'])."'>
													<a class='ct-tooltip-link' href='#' data-toggle='tooltip' title='".$label_language_values['its_your_Cleanto_booking_form_page_url']." e.g. ".SITE_URL."'><i class='fa fa-info-circle fa-lg'></i></a>
												</div>
											</td>
										</tr>
										<tr>
											...
											<td>
												<div class='form-group'>
													<input type='text' size='50' class='form-control ct_gc_admin_url' name='ct_gc_admin_url v_c' data-names='ct_gc_admin_url' value='".$setting->get_staff_option('gc_admin_url',$_SESSION['staffid'])."'>
													<a class='ct-tooltip-link' href='#' data-toggle='tooltip' title='".$label_language_values['Its_your_Cleanto_Google_Settings_page_url']." e.g. ".SITE_URL."admin/
													settings.php'><i class='fa fa-info-circle fa-lg'></i></a>
												</div>
											</td>
									...
									<tfoot>
										<tr>
											<td></td>
											<td>
												<a id='gc_setting' name='' class='btn btn-success save_google_calender_staff_settings' >".$label_language_values['save_setting']."</a>
											</td>
										</tr>
									</tfoot>
								</table>
				...
				if($setting->get_staff_option('gc_status',$_SESSION['staffid'])=='Y' && $setting->get_staff_option('gc_id',$_SESSION['staffid']) != '' && $setting->get_staff_option('gc_client_id',$_SESSION['staffid']) != '' && $setting->get_staff_option('gc_client_secret',$_SESSION['staffid']) != '') {
					$GcclientID = $setting->get_staff_option('gc_client_id',$_SESSION['staffid']);
					$GcclientSecret = $setting->get_staff_option('gc_client_secret',$_SESSION['staffid']);
					$GcEDvalue = $setting->get_staff_option('gc_status',$_SESSION['staffid']);
					$ct_gc_admin_url = $setting->get_staff_option('gc_admin_url',$_SESSION['staffid']);
					$ct_gc_id = $setting->get_staff_option('gc_id',$_SESSION['staffid']);
					$client = new Google_Client();
					$client->setApplicationName('Google Calender');
					$client->setClientId($GcclientID);
					$client->setClientSecret($GcclientSecret);
					...
					if(isset($_GET['action']) && $_GET['action']=='gcd'){
						$revokeaccesstoken = $setting->get_staff_option('gc_token',$_SESSION['staffid']);
						$client->revokeToken($revokeaccesstoken);
					}
					
					if(isset($_GET['code']) && $_GET['code']!=''){
						$access_token =  $client->authenticate($_GET['code']);
						$setting->set_staff_option('gc_token',$access_token,$_SESSION['staffid']);
						header('Location:'.$ct_gc_admin_url);
					}
					...
					curl_setopt_array($curlcalenders, array(
						CURLOPT_RETURNTRANSFER => 1,
						CURLOPT_URL => SITE_URL.'extension/GoogleCalendar/staff_callist.php?pid='.$_SESSION['staffid'],
						CURLOPT_FRESH_CONNECT =>true,
						CURLOPT_USERAGENT => 'Cleanto'
					));
					$response = curl_exec($curlcalenders);
											...
											<td>
												<div class='form-group'>
													<label class='ctoggle-gc-status_configure' for='gc-status'>
														...
														if($setting->get_staff_option('gc_status_configure',$_SESSION['staffid'])=='Y'){	
															$menu_content .= 'checked';
														} 
														$menu_content .= " id='ct-gc-status-configure' data-onstyle='success' data-offstyle='danger' />
													</label>
										...
										<tr>
											...
											<td>
												<div class='form-group'>
													<label class='ctoggle-gc-sync_configure' for='gc-sync'>
														<input class='cta-toggle-checkbox' data-toggle='toggle' data-size='small' type='checkbox'"; 
														if($setting->get_staff_option('gc_status_sync_configure',$_SESSION['staffid'])=='Y'){	
															$menu_content .= 'checked';
														} 
														$menu_content .= " id='ct-gc-status-sync-configure' data-onstyle='success' data-offstyle='danger' />
													</label>
...
function gc_staff_settings_save_ajax() {
	...
	if(isset($_POST['ct_gc_staff_settings']) && $_POST['ct_gc_staff_settings'] == '1') {
		...
		foreach($GC_option as $option_key=>$option_value){
			echo $option_key."==".$option_value."==".$_SESSION['staffid'];
			$GC=$setting->set_staff_option($option_key,$option_value,$_SESSION['staffid']);
		}
	}
}
...
function gc_staff_setting_configure_ajax() {
	...
	if(isset($_POST['gc_staff_setting_configure']) && $_POST['gc_staff_setting_configure'] == '1') {
		...
		foreach($GC_id_configure as $option_key=>$option_value){
			$GC_id=$setting->set_staff_option($option_key,$option_value,$_SESSION['staffid']);
		}
	}
}
...
function gc_staff_setting_disconnect_ajax() {
	...
	if(isset($_POST['disconnect_gc_staff']) && $_POST['disconnect_gc_staff'] == '1') {
		...
		foreach($GC_option_unset as $option_key=>$option_value){
			$GC_unset=$setting->set_staff_option($option_key,$option_value,$_SESSION['staffid']);
		}
	}
}
...
function gc_add_booking_ajax() {
	global $settings,$booking_date_time,$conn,$booking,$recurrence_booking_status,$recurrence_booking_type,$recurrence_end_date;
	$add_booking = '';
			...
			for($j=1;$j<=$total_days;$j++) {
				if(strtotime($recurr_booking_date_time) <= strtotime($recurrence_end_date.' 23:59')){
					if($j == '1') {
						...
						$datetime = explode(' ',$recurr_booking_date_time);
						$date = $datetime[0];
						$start = $datetime[1];
			...
			for($j=1;$j<=$total_days;$j++) {
				if(strtotime($recurr_booking_date_time) <= strtotime($recurrence_end_date.' 23:59')){
					if($j == '1') {
						...
						$s_datetime = explode(' ',$recurr_booking_date_time);
						$s_date = $s_datetime[0];
