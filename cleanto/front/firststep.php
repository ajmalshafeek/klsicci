	...
	if ($_POST['coupon_code'] != '')
		...
		if ($result)
			...
			if ($result['coupon_used'] < $result['coupon_limit'] && $curr_date <= $coupon_exp_date)
				...
				$jsonn_array['total_amount'] = $general->ct_price_format($alltot , $symbol_position, $decimal);
