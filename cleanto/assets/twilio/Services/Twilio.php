...
abstract class Base_Services_Twilio extends Services_Twilio_Resource
{
    ...
    public function __construct(
        ...
        if (null === $_http) {
            if (!in_array('openssl', get_loaded_extensions())) {
                throw new Services_Twilio_HttpException("The OpenSSL extension is required but not currently enabled. For more information, see https://php.net/manual/en/book.openssl.php");
            }
    ...
    public function deleteData($path, $params = array())
    {
        ...
        return $this->_makeIdempotentRequest(array($this->https, 'delete'),
    ...
    )
    {
        ...
        return $this->_makeIdempotentRequest(array($this->https, 'get'),
            $uri, $this->retryAttempts);
    }
