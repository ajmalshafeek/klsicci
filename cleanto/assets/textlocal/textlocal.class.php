...
class Textlocal {
	 ...
	 * @throws Exception
	 */
	public function sendSms($numbers, $message, $sender, $sched=null) {
	 ...
	 * @param $numbers
	 * @param $fileSource - either an absolute or relative path, or https url to a file.
	 * @param $message
	 * @param null $sched
	 * @return array|mixed
	 * @throws Exception
	 */
	public function sendMms($numbers, $fileSource, $message, $sched=null) {
	 ...
	 * @throws Exception
	 */
	public function sendMmsGroup($groupId, $fileSource, $message, $sched=null) {
