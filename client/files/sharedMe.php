...
<head>
    ...
    <title>Jsuit Enterprise Solutions and Integrated Digital Signature (JES-IDS) - Shared With Me</title>
        ...
        <div class="row">
            ...
            if(isset($_SESSION['fm']) && !empty($_SESSION['fm'])){ ?>
                ...
                <div class="col-sm-10 no-gutters">
                    ...
                    <iframe src="../../tiny/smanager.php<?php echo $query; ?>" style="border: 0px;width:100%;height: 800px" id="myIframe" onload="adjustIframe(this)"></iframe>
