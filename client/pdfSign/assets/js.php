    ...
    function quickView(id) {
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                document.getElementById("viewSKU").innerText = res.sku;
                document.getElementById("viewBrand").innerText = res.brand;
                document.getElementById("viewPrice").innerText = "RM " + res.price;
                document.getElementById("viewTag").innerHTML = '<li><a href="#">' + res.model + '</a></li>';
