  ...
  <section class="single-banner" style="background: url(./img/research-grant.jpg) no-repeat center; background-size: cover;">
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">technical inquiry</li>
      </ol>
    </div>
  </section>
        ...
        <div class="col-lg-12">
          <div class="account-card">
            <div class="account-title">
              <h4>Technical Inquiry</h4><button data-toggle="modal" data-target="#profile-edit">support</button>
            </div>
            <div class="account-content">
                <div class="row">
                    <div class="col-12 text-center">
                        <img src="img/technical-client-1.png" class="tech-1" />
                        <img src="img/technical-client-2.png" class="tech-2" />
                        <img src="img/technical-client-3.png" class="tech-3" />
