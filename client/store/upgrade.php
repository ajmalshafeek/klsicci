            ...
            <div class="col-lg-12">
                <div class="account-card">
                    <div class="account-title">
                        <h4>Membership Plan</h4><!--<button data-toggle="modal" data-target="#profile-edit">request</button> -->
                    </div>
                    <div class="account-content">
                        <div class="row">
                            <div class="col-12 text-center">
                                <form action="../../phpfunctions/registration.php" method="post">
                                    <div class="row plan"><?php planListRenualLoginRegistration() ?></div>
                                    <div><button class="btn btn-info" type="submit" name="planSubscribe">Subscribe</button></div>
                                </form>
                                <?php /* <img src="img/mem-renewal-1.png" class="tech-1" style="max-width: 100%"/>
                        <img src="img/mem-renewal-2.png" class="tech-2" style="max-width: 100%" />
                        <img src="img/mem-renewal-3.png" class="tech-3" style="max-width: 100%" />
                        <img src="img/mem-renewal-4.png" class="tech-4" style="max-width: 100%" />
                        <img src="img/mem-renewal-5.png" class="tech-5" style="max-width: 100%" />
