        ...
        <div class="col-lg-12">
          <div class="account-card">
            <div class="account-title">
              <h4>Professional Development Registration</h4><button data-toggle="modal" data-target="#profile-edit">request</button>
            </div>
            <div class="account-content" style="background-color: #f9f9f9; border-radius: 10px;">
                <div class="row">
                    <div class="col-12 text-center">
                        <img src="img/pd-registration-client.png" class="tech-1" />
