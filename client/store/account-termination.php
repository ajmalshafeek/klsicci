  ...
  <section class="single-banner" style="background: url(./img/research-grant.jpg) no-repeat center; background-size: cover;">
    <div class="container">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">account termination</li>
      </ol>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
          ...
          if(isset($_SESSION['feedback'])) {
              echo '<div class="col-12 my-3">'. $_SESSION['feedback'] . '</div>';
              unset($_SESSION['feedback']);
          } ?>
        <div class="col-lg-12">
          <div class="account-card">
            <div class="account-title">
              <h4>Account Termination</h4><!--<button data-toggle="modal" data-target="#profile-edit">support</button>-->
            </div>
            <div class="account-content">
                <div class="row">

                    <div class="col-12 text-center">
                        <div class="modal-form" style="margin-left: auto;margin-right: auto">
                            <form action="<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot']; ?>/phpfunctions/registration.php" method="post">
                                <div class="py-2">
                                    <input type="text" class="form-control" name="name" value="<?php echo $_SESSION['name']; ?>" disabled>

                                </div>
                                <div class="py-2">
                                    <input type="text" class="form-control" name="cid" value="<?php echo $_SESSION['companyId']; ?>" disabled>
                                </div>
                                <div class="py-2">
                                    <div class="small">Reason for terminate account</div>
                                    <textarea type="text" class="form-control" name="notes" rows=5 required></textarea>
                                </div>
                                <div class="py-2">
                                    <input type="checkbox" name="condition" rows=5 required /> I am agree with all <a href="<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot']; ?>/TERMS%20AND%20CONDITIONS.pdf" target="_blank">terms and conditions</a>.
                                </div>
                                <div class="py-2">
                                    <button type="submit" class="button btn-info form-control form-button" style="background-color: #151414" value="<?php echo $_SESSION['companyId']; ?>" name="terminate" >Submit Request</button>
                                </div>


                            </form>
                        </div>
                      <!--  <img src="img/mem-termination-1.png" class="tech-1" style="max-width: 500px" />
                        <img src="img/mem-termination-2.png" class="tech-2" style="max-width: 500px" />
                        <img src="img/mem-termination-3.png" class="tech-3" style="max-width: 500px" />
