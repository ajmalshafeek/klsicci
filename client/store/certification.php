        ...
        <div class="col-lg-12">
          <div class="account-card">
            <div class="account-title">
              <h4>Certification</h4><!--<button data-toggle="modal" data-target="#profile-edit">request</button>-->
            </div>
            <div class="account-content">
                <div class="row">
                    <div class="col-12 text-center">
                        <img src="img/mem-cetification.png" class="tech-1" style="max-width: 100%"/>
                        <img src="img/mem-certification-view.jpg" class="tech-2" style="max-width: 100%" />
