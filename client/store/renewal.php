        ...
        <div class="col-lg-12">
          <div class="account-card">
            <div class="account-title">
              <h4>Renewal</h4><!--<button data-toggle="modal" data-target="#profile-edit">request</button> -->
            </div>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        ...
                        <div class="row plan"><?php planListRenualLoginRegistration() ?></div>
                            <div><button class="btn btn-info" type="submit" name="planRenew">Renewal of plan</button></div>
                        </form>
