...
?>
  <section class="single-banner" style="background: url(./img/research-grant-banner-1.jpg) no-repeat center; background-size: cover;">
    <div class="container">
      <h2>Research Grant</h2>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="./store.php">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">research grant</li>
      </ol>
    </div>
  </section>
        ...
        <div class="col-lg-12">
          <div class="account-card">
            <div class="account-title">
              <h4>Research Grant</h4><button data-toggle="modal" data-target="#profile-edit">apply</button>
            </div>
            <div class="account-content">
                <div class="row">
                    <div class="col-12">
                        <img src="img/mem-research-grant.png" class="tech-1" style="max-width: 100%"/>
                        <img src="img/mem-research-grant-popup.png" class="tech-2" style="max-width: 100%" />
                        ...
                        <div class="alert-success py-2 px-2 text-center">
                            Email Successfuly send to technical@iiam.com.my. thank you.
                        </div>
                        <?php
                            unset($_POST);
                        }  */ ?>
