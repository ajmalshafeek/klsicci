 ...
 <?php require("./assets/css.php"); ?>
  ...
  <style>
      .modal-content {
          ...
          padding: 20px;
          border-radius: 15px;
          box-shadow: 0 0 15px -7px #4c4c4c;
      }
...
?>
  <section class="single-banner" style="background: url(./img/epf-banner.jpg) no-repeat center; background-size: cover;">
    <div class="container">
      <h2>EPF Withdrawal</h2>
      <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="./store.php">Home</a></li>
        <li class="breadcrumb-item active" aria-current="page">epf withdrawal</li>
      </ol>
    </div>
  </section>
        ...
        <div class="col-lg-12">
          <div class="account-card">
            <div class="account-title">
              <h4>Your Profile</h4><button data-toggle="modal" data-target="#profile-edit">epf withdrawal</button>
            </div>
 ...
 */ ?>
        <div class="col-lg-12">
          <div class="account-card">
            <div class="account-title">
              <h4>EPF Withdrawal for the CIA Programme</h4><button data-toggle="modal" data-target="#address-add">request</button>
            </div>
            <div class="account-content">
              <div class="row">
                <?php /*  <img src="img/mem-epf-withdrawal.png" class="tech-1" style="max-width: 100%" />
                  <img src="img/mem-epf-withdrawal-popup.png" class="tech-2" style="max-width: 100%" />
    ...
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content"><button class="modal-close" data-dismiss="modal"><i class="icofont-close"></i></button>
         <!--  <form class="modal-form" method="post" <?php // method="post" action="../../phpfunctions/store.php" ?>> -->
          <div class="form-title">
            <h3>EPF Withdrawal</h3>
          </div>
          <div class="form-group"><label class="form-label">CIA Programme</label><select name="title" class="form-select">
              <option selected="CIA Programme">CIA Programme</option>
          ...
          <div class="form-group">
              ...
              <textarea class="form-control" name="value" placeholder="Admin will contact once receive this request."></textarea>
          </div>
              <div class="form-group">
                  <label class="form-label">Document</label>
                  <input type="file" class="form-control" name="file" placeholder="Document" accept="application/pdf" />
              </div>
              <button data-toggle="modal" data-target="#infomsg" class="form-btn">Send</button>
            <?php /* <button class="form-btn" name="addDetails" type="submit">Send</button> */ ?>
        <!-- </form> -->
      </div>
    </div>
  </div>
<div class="modal fade" id="infomsg" class="address-edit">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content"><button class="modal-close" data-dismiss="modal"><i class="icofont-close"></i></button>
            <div class="form-title">
                YOUR APPLICANT IS IN PROGRESS.<br />
                YOU CAN DOWNLOAD THE EPF WITHDRAWAL LETTER<br/>
                IN THE  MY DRIVE.</h3>
            </div>
        </div>
    </div>
