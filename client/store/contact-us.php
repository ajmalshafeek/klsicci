            ...
            <div class="account-content">
                <div class="row">
                    <div class="col-12 text-center">
                        <h2 class="mb-4">GK & Associates</h2>
                        <h3>Address</h3>
                        Registration No: AF1195<br />
                        <hr width="50px" />
                        <h3>Registered Office Address:</h3>
                        NW-02-35, Cova Square,<br />
                        Jalan Teknologi PJU 5,<br />
                        Kota Damansara,<br />
                        47810 Petaling Jaya,<br />
                        Selangor<br />
                        <hr width="50px" />
                        <h3>Management Office Address:</h3>
                        L1-23A, Cova Square,<br />
                        Jalan Teknologi PJU 5,<br />
                        Kota Damansara,<br />
                        47810 Petaling Jaya,<br />
                        Selangor<br />
