...
<body class="fixed-nav ">
        ...
        <div class='card mb-3'>
            ...
            <div class='card-body'>
                <div class='table-responsive'>
                    <?php
                    require_once($_SERVER['DOCUMENT_ROOT'] . $config['appRoot'] . "/phpfunctions/digitalSign.php");
                    $table = "";
                    if ($_SESSION['role'] == 1) {
    ...
    <form method="POST" action="../../phpfunctions/digitalSign.php" class="needs-validation" novalidate>
