    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            if(isset($_POST['sign']) && $_POST['sign'] != '' && isset($_POST['img']) && $_POST['img'] != ''){
                ...
                $s->use_template_pdf($fileName, $_POST['template'],$_POST['x'],$_POST['y'],$_POST['p']); //
            ...
            <form action="" id="f" method="post" class="needs-validation">
                ...
                <input type="hidden" name="x" id="x" value="<?php if(isset($_POST['x'])){ echo $_POST['x'];} ?>" />
                <input type="hidden" name="y" id="y" value="<?php if(isset($_POST['y'])){ echo $_POST['y'];} ?>" />
                <input type="hidden" name="p" id="p" value="<?php if(isset($_POST['p'])){ echo $_POST['p'];} ?>" />
                <input type="hidden" name="template" id="template" value="<?php if(isset($_POST['template'])){ echo $_POST['template'];} ?>" />
            ...
            if(file_exists($_SERVER['DOCUMENT_ROOT'].$config['appRoot']."/resources/2/pdf/".$_SESSION['pdfFileName'])) {
                echo('<p><a href="https://'.$_SERVER['HTTP_HOST'].$config['appRoot']."/resources/2/pdf/".$_SESSION['pdfFileName'].'" class="btn" target="_blank">Check Signature on PDF</a></p>'); ?>
                    ...
                    <form action="https://<?php echo $_SERVER['HTTP_HOST'].$config['appRoot']; ?>/phpfunctions/signPDF.php" id="f" method="post" class="needs-validation">
