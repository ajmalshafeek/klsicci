        ...
        <form method="POST" action="../../phpfunctions/vehicle.php" class="needs-validation" enctype="multipart/form-data" novalidate>
            ...
            <div id="vehicleForm">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="hidden" name="vehicleId" id="vehicleId" value="<?php echo $_SESSION['vehicleIdEdit'] ?>">
...
<script>
    $(document).ready(function () {
        const vid =""+"<?php echo $_SESSION['vehicleIdEdit']; ?>";
        const brand =""+"<?php echo $_SESSION['vehicleBrandEdit']; ?>";
        const category =""+"<?php echo $_SESSION['vehicleCategoryEdit']; ?>";
        const type =""+"<?php echo $_SESSION['vehicleTypeEdit']; ?>";
        const driver=""+"<?php echo $_SESSION['vehicleDriverEdit']; ?>";
        const number =""+"<?php echo $_SESSION['vehicleNumberEdit']; ?>";
        $('#vehicleNo').val(number);
        $('#driver').val(driver);
