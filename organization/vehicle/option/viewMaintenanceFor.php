...
?>
     ...
     function maintenanceForEdit(str){
       ...
       $("#maintenanceForIdToEdit").val(str.value);
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">View Maintenance For</li>
      ...
      <?php
        ...
        <div class='card mb-3'>
            ...
            Maintenance For List
				  </div>
          <div class='card-body'>
          <?php
          vehicleMaintenanceForListTableEditable();
          ?>
    ...
    <form method="POST" action="../../../phpfunctions/maintenance.php" >
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <input type="text" hidden name="maintenanceForIdToEdit" id="maintenanceForIdToEdit" value=""  />
                <button type="submit" name='editMaintenanceType' class="btn btn-primary" >Edit</button>
                <button type="submit" name='removeMaintenanceType' class="btn btn-primary" >Remove</button>
