        ...
        <form method="POST" action="../../../phpfunctions/vehicle.php" class="needs-validation" novalidate >
            ...
            <div id="criteriaForm">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10"   >
                        <input type="text" value="<?php echo $idEdit ?>"  class="form-control" id="vehicleTypeId" name="vehicleTypeId" required disabled />
                        <input type="text" value="<?php echo $idEdit ?>"  class="form-control" id="vehicleTypeId" name="vehicleTypeId" hidden />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10"   >
                        <input type="text" value="<?php echo $productType ?>"  class="form-control" id="vehicleType" name="vehicleType" required />
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <button name='editVehicleTypeProcess' class="btn btn-primary btn-lg btn-block" type='submit' style="text-align: center;">SUBMIT</button>
                    </div>
                </div>
            </div>
        </form>
