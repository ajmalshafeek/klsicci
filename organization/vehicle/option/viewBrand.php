...
?>
     ...
     function vehicleBrandEdit(str){

       $("#vehicleBrandIdToEdit").val(str.value);
...
?>
  <div class="content-wrapper">
    ...
    <div class="modal fade" id="vehicleBrandEditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <input type="text" hidden name="vehicleBrandIdToEdit" id="vehicleBrandIdToEdit" value=""  />
                <button type="submit" name='editVehicleBrand' class="btn btn-primary" >Edit</button>
