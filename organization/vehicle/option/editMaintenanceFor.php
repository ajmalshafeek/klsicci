...
$productType=$_SESSION['maintenanceFor'];
$idEdit=$_SESSION['maintenanceForId'];
...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb col-md-12">
            ...
            <li class="breadcrumb-item active">Edit Maintenance For</li>

        </ol>
    </div>
    <div class="container" >
        <form method="POST" action="../../../phpfunctions/maintenance.php" class="needs-validation" novalidate >
            <?php
            ...
            <div id="criteriaForm">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10"   >
                        <input type="text" value="<?php echo $idEdit ?>"  class="form-control" id="maintenanceForId" name="maintenanceForId" required disabled />
                        <input type="text" value="<?php echo $idEdit ?>"  class="form-control" id="maintenanceForId" name="maintenanceForId" hidden />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10"   >
                        <input type="text" value="<?php echo $productType ?>"  class="form-control" id="maintenanceFor" name="maintenanceFor" required />
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <button name='editMaintenanceForProcess' class="btn btn-primary btn-lg btn-block" type='submit' style="text-align: center;">SUBMIT</button>
                    </div>
                </div>
            </div>
        </form>
