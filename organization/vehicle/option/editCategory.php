...
$productType=$_SESSION['vehicleCategoryEdit'];
$idEdit=$_SESSION['vehicleCategoryIdEdit'];
        ...
        <form method="POST" action="../../../phpfunctions/vehicle.php" class="needs-validation" novalidate >
            ...
            <div id="criteriaForm">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10"   >
                        <input type="text" value="<?php echo $idEdit ?>"  class="form-control" id="vehicleCategoryId" name="vehicleCategoryId" required disabled />
                        <input type="text" value="<?php echo $idEdit ?>"  class="form-control" id="vehicleCategoryId" name="vehicleCategoryId" hidden />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10"   >
                        <input type="text" value="<?php echo $productType ?>"  class="form-control" id="vehicleCategory" name="vehicleCategory" required />
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <button name='editVehicleCategoryProcess' class="btn btn-primary btn-lg btn-block" type='submit' style="text-align: center;">SUBMIT</button>
                    </div>
                </div>
