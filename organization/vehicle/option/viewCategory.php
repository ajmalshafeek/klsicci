...
?>
     ...
     function vehicleCategoryEdit(str){

       $("#vehicleCategoryIdToEdit").val(str.value);
...
?>
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <?php
        ...
        <div class='card mb-3'>
          ...
          <div class='card-body'>
          <?php
          vehicleCategoryListTableEditable();
          ?>
    ...
    <form method="POST" action="../../../phpfunctions/vehicle.php" >

    <div class="modal fade" id="vehicleCategoryEditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <input type="text" hidden name="vehicleCategoryIdToEdit" id="vehicleCategoryIdToEdit" value=""  />
                <button type="submit" name='editVehicleCategory' class="btn btn-primary" >Edit</button>
                <button type="submit" name='removeVehicleBrand' class="btn btn-primary" >Remove</button>
