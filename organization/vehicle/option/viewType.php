...
?>
     ...
     function vehicleTypeEdit(str){

       $("#vehicleTypeIdToEdit").val(str.value);
...
?>
  <div class="content-wrapper">
    ...
    <div class="modal fade" id="vehicleTypeEditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <input type="text" hidden name="vehicleTypeIdToEdit" id="vehicleTypeIdToEdit" value=""  />
                <button type="submit" name='editVehicleType' class="btn btn-primary" >Edit</button>
                <button type="submit" name='removeVehicleType' class="btn btn-primary" >Remove</button>
