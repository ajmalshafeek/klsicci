...
$name=$_SESSION['vehicleBrandEdit'];
$idEdit=$_SESSION['vehicleBrandIdEdit'];
?>
<!DOCTYPE html >
          ...
          <?php
            ...
            <div id="criteriaForm">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10"   >
                  <input type="text" value="<?php echo $idEdit ?>"  class="form-control" id="vehicleBrandId" name="vehicleBrandId" required disabled />
                    <input type="text" value="<?php echo $idEdit ?>"  class="form-control" id="vehicleBrandId" name="vehicleBrandId" required hidden />
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10"   >
                  <input type="text" value="<?php echo $name ?>"  class="form-control" id="vehicleBrand" name="vehicleBrand" required />
                <div class="invalid-feedback">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <button name='editVehicleBrandProcess' class="btn btn-primary btn-lg btn-block" type='submit' style="text-align: center;">SUBMIT</button>
                  </div>
              </div>
