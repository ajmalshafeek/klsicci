...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">Membership Over</li>
      </ol>
     </div>
      ...
      <?php
        ...
        <div class='card mb-3'>
		      <div class='card-header'>
                  ...
                  Membership Over List
				  </div>

            <div class="row">
                <div class="col-12 text-center">
                    <img src="img/adm-member-over-1.png" class="tech-1" style="max-width: 100%" />
                    <img src="img/adm-member-over-2.png" class="tech-2" style="max-width: 100%" />
                    <img src="img/adm-member-over-3.png" class="tech-3" style="max-width: 100%" />
                    <img src="img/adm-member-over-4.png" class="tech-4" style="max-width: 100%" />
                    <img src="img/adm-member-over-5.png" class="tech-5" style="max-width: 100%" />
                    <img src="img/adm-member-over-6.png" class="tech-6" style="max-width: 100%" />
                    <img src="img/adm-member-over-7.png" class="tech-7" style="max-width: 100%" />
