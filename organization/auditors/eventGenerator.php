...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">Event Generator</li>
      </ol>
     </div>
        ...
        <div class='card mb-3'>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <img src="img/event-generator-1.png" class="tech-1" />
                    <img src="img/event-generator-2.png" class="tech-2" />
                    <img src="img/event-generator-3.png" class="tech-3" />
                    <img src="img/event-generator-4.png" class="tech-4" />
                    <img src="img/event-generator-5.png" class="tech-5" />
                    <img src="img/event-generator-6.png" class="tech-6" />
                    <img src="img/event-generator-7.png" class="tech-7" />
                    <img src="img/event-generator-8.png" class="tech-8" />
                    <script>
                        var url="";
                        $('.tech-2').css('display','none'); $('.tech-3').css('display','none');
                        $('.tech-4').css('display','none'); $('.tech-5').css('display','none');
                        $('.tech-6').css('display','none'); $('.tech-7').css('display','none');
                        ...
                        $('.tech-8').on('click',function () {
                            url = '<?php echo 'https://' . $_SERVER['HTTP_HOST'] . $config['appRoot'] . '/organization/auditors/eventGeneratedView.php'; ?>';
