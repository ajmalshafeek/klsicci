    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        <li class="breadcrumb-item">
          ...
          <li class="breadcrumb-item active">Certified Members</li>
      </ol>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <img src="img/certified-members-1.png" class="tech-1 tech-3.1" />
                <img src="img/certified-members-2.png" class="tech-2" />
                <img src="img/certified-members-2.1.png" class="tech-3" />
                <script>
