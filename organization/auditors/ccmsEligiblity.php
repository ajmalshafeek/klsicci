    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        <li class="breadcrumb-item">
          ...
          <li class="breadcrumb-item active">CCMS Eligibility</li>
      </ol>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <img src="img/adm-statement-of-eligiblity-1.png" class="tech-1" />
                <img src="img/eligibility-2.png" class="tech-2" />
                <img src="img/eligibility-2.1.png" class="tech-3" />
                <img src="img/adm-statement-of-eligiblity-1.png" class="tech-31" />
                <img src="img/eligibility-3.png" class="tech-4" />
                <img src="img/eligibility-4.png" class="tech-5" />
                <script>
                    $('.tech-2').css('display','none');
                    $('.tech-3').css('display','none');
                    $('.tech-31').css('display','none');
                    ...
                    $('.tech-3').on('click',function () {
                        $('.tech-31').css('display','initial');
                        $('.tech-3').css('display','none');
                    });

                    $('.tech-31').on('click',function () {
