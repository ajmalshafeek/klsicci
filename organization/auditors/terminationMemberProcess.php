...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">Termination Member Process</li>
      </ol>
     </div>
      ...
      <?php
        ...
        <div class='card mb-3'>
		      <div class='card-header'>
                  ...
                  Termination Member Process List
				  </div>
            <div class="row">
                <div class="col-12 text-center">
                    <img src="img/adm-termination-member-request-1.png" class="tech-1" style="max-width: 100%" />
                    <img src="img/adm-termination-member-request-2.png" class="tech-2" style="max-width: 100%" />
                    <img src="img/adm-termination-member-request-3.png" class="tech-3" style="max-width: 100%" />
                    <script>
