    ...
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        <li class="breadcrumb-item">
          ...
          <li class="breadcrumb-item active">Candidates Reporting</li>
      </ol>
    </div>
    <div class="container">
        <div class="row">
            <div class="col-12 text-center">
                <img src="img/candiates-report-1.png" class="tech-1" />
                <img src="img/candiates-report-2.png" class="tech-2" />
                <img src="img/candiates-report-3.png" class="tech-3" />
                <img src="img/candiates-report-4.png" class="tech-4" />
                <script>
