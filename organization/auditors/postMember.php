...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">Post Member</li>
      </ol>
     </div>
        ...
        <div class='card mb-3'>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <img src="img/adm-post-member-1.png" class="tech-1" style="max-width: 100%" />
                    <img src="img/adm-post-member-2.png" class="tech-2" style="max-width: 100%" />
                    <img src="img/adm-post-member-3.png" class="tech-3" style="max-width: 100%" />
                    <img src="img/adm-post-member-2.png" class="tech-4" style="max-width: 100%" />
                    <img src="img/adm-post-member-5.png" class="tech-5" style="max-width: 100%" />
                    <img src="img/adm-post-member-2.png" class="tech-6" style="max-width: 100%" />
                    <img src="img/adm-post-member-7.png" class="tech-7" style="max-width: 100%" />
                    <img src="img/adm-post-member-2.png" class="tech-8" style="max-width: 100%" />
                    <img src="img/adm-post-member-9.png" class="tech-9" style="max-width: 100%" />
                    ...
                    <script>
                        ...
                        $('.tech-7').css('display','none');
                        $('.tech-8').css('display','none');
                        $('.tech-9').css('display','none');
                        ...
                        $('.tech-6').on('click',function () {
                            $('.tech-7').css('display','initial');
                            $('.tech-6').css('display','none');
                        });
                        $('.tech-7').on('click',function () {
                            $('.tech-8').css('display','initial');
                            $('.tech-7').css('display','none');
                        });
                        $('.tech-8').on('click',function () {
                            $('.tech-9').css('display','initial');
                            $('.tech-8').css('display','none');
                        });
                        $('.tech-9').on('click',function () {
