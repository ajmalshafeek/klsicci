...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">Technical Inquiry</li>
      </ol>
     </div>
        ...
        <div class='card mb-3'>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <img src="img/technical-1.png" class="tech-1" />
                    <img src="img/technical-2.png" class="tech-2" />
                    <img src="img/technical-3.png" class="tech-3" />
                    <script>
