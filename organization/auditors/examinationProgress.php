...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">Examination Progress</li>
      </ol>
     </div>
      ...
      <?php
        ...
        <div class='card mb-3'>
		      <div class='card-header'>
                  ...
                  Examination Progress List
				  </div>

            <div class="row">
                <div class="col-12 text-center">
                    <img src="img/exam-progress-1.png" class="tech-1" />
                    <img src="img/exam-progress-2.png" class="tech-2" />
                    <img src="img/exam-progress-3.png" class="tech-3" />
                    <img src="img/exam-progress-4.png" class="tech-4" />
                    <script>
