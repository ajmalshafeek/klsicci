...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">EPF Letter <?php if($_SESSION['role']==72){ echo 'Final'; } ?> Approval</li>
      </ol>
     </div>
      ...
      <?php
        ...
        <div class='card mb-3'>
		      <div class='card-header'>
                  ...
                  EPF Letter <?php if($_SESSION['role']==72){ echo 'Chairman'; } ?> List
				  </div>
            <div class="row">
                <div class="col-12 text-center">
                    <?php if($_SESSION['role']==72){ ?>
                        <img src="img/chairman-epf-approval-1.png" class="tech-1" style="max-width: 100%" />
                        <img src="img/chairman-epf-approval-2.png" class="tech-2" style="max-width: 100%" />
                        <!--<img src="img/chairman-epf-approval-nortification.png" class="tech-3" style="max-width: 100%" />-->
                    <?php } else{ ?>
                    <img src="img/adm-epf-approval-1.png" class="tech-1" style="max-width: 100%" />
                    <img src="img/adm-epf-approval-2.png" class="tech-2" style="max-width: 100%" />
                    <img src="img/adm-epf-approval-3.png" class="tech-3" style="max-width: 100%" />
                    <img src="img/adm-epf-approval-4.png" class="tech-4" style="max-width: 100%" />
