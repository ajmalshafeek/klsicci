...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">Training and Development</li>
      </ol>
     </div>
        ...
        <div class='card mb-3'>
            <div class="row">
                <div class="col-12 text-center">
                    <img src="img/training-develpment-1.png" class="tech-1" style="max-width: 100%"/>
                    <img src="img/training-develpment-2.png" class="tech-2" style="max-width: 100%"/>
                    <img src="img/training-develpment-3.png" class="tech-3" style="max-width: 100%"/>
                    <img src="img/training-develpment-4.png" class="tech-4" style="max-width: 100%"/>
                    <script>
