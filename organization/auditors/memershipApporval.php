      ...
      <?php
        ...
        <div class='card mb-3'>
		      <div class='card-header'>
                  ...
                  Membership Approval List
				  </div>

            <div class="row">
                <div class="col-12 text-center">
                    <?php if($_SESSION['role']==72){?>
                        <div class="text-center py-2 alert-success">
                            <h5>Approval By Executive Director</h5>
                        </div>
                    <img src="img/chairman-member-approval-1.png" class="tech-1" style="max-width: 100%"/>
                    <img src="img/chairman-member-approval-2.png" class="tech-2" style="max-width: 100%" />
                    <!-- <img src="img/chairman-member-approval-3.png" class="tech-3" style="max-width: 100%" /> -->
                    <?php } else if($_SESSION['role']==54){ ?>
                        <div class="text-center py-2 alert-success">
                            <h5>Approval By Admin</h5>
                        </div>
                        <img src="img/ed-member-approvel-1.png" class="tech-1" style="max-width: 100%"/>
                        <img src="img/ed-member-approvel-2.png" class="tech-2" style="max-width: 100%" />
                        <img src="img/ed-member-approvel-3.png" class="tech-3" style="max-width: 100%" />
                    <?php } else{ ?>
                        <div class="text-center py-2 alert-success">
                            <h5>Pending for First Approval </h5>
                        </div>
                        <img src="img/adm-member-approval-1.png" class="tech-1" style="max-width: 100%"/>
                        <img src="img/adm-member-approval-2.png" class="tech-2" style="max-width: 100%" />
                        <img src="img/adm-member-approval-3.png" class="tech-3" style="max-width: 100%" />
                    <?php } ?>
                    <script>
