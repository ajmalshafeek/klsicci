      ...
      <?php
        ...
        <div class='card mb-3'>
		      <!--<div class='card-header'>
                  ...
                  Technical Inquiry List
				  </div> -->

            <div class="row">
                <div class="col-12 text-center">
                    <?php if($_SESSION['role']==1){ ?>
                    <img src="img/adm-requisition-1.jpg" class="tech-1" style="max-width: 100%"/>
                    <img src="img/adm-requisition-2.jpg" class="tech-2" style="max-width: 100%" />
                    <img src="img/adm-requisition-3.jpg" class="tech-3" style="max-width: 100%" />
                    <img src="img/adm-requisition-4.jpg" class="tech-4" style="max-width: 100%" />
                    ...
                    <?php } else { ?>
                    <img src="img/staff-requisition-1.jpg" class="tech-1" style="max-width: 100%"/>
                    <img src="img/staff-requisition-2.jpg" class="tech-2" style="max-width: 100%" />
                    <img src="img/staff-requisition-3.jpg" class="tech-3" style="max-width: 100%" />
                    <img src="img/staff-requisition-4.jpg" class="tech-4" style="max-width: 100%" />
                    <img src="img/staff-requisition-5.jpg" class="tech-5" style="max-width: 100%" />
