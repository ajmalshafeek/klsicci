...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">Certificate eSignature</li>
      </ol>
     </div>
        ...
        <div class='card mb-3'>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <?php if($_SESSION['role']==72){ ?>
                        <img src="img/cahirman-certificate-approval-1.png" class="tech-1" style="max-width: 100%" />
                        <img src="img/cahirman-certificate-approval-2.png" class="tech-2" style="max-width: 100%" />
                        <img src="img/cahirman-certificate-approval-3.png" class="tech-3" style="max-width: 100%" />
                        <img src="img/cahirman-certificate-approval-4.png" class="tech-4" style="max-width: 100%" />
                        <img src="img/cahirman-certificate-approval-5.png" class="tech-5" style="max-width: 100%" />
                        <img src="img/cahirman-certificate-approval-6.png" class="tech-6" style="max-width: 100%" />
                    <?php } else { ?>
                        <img src="img/adm-certificate-approval-1.png" class="tech-1" style="max-width: 100%" />
                        <img src="img/adm-certificate-approval-2.png" class="tech-2" style="max-width: 100%" />
                        <img src="img/adm-certificate-approval-3.png" class="tech-3" style="max-width: 100%" />
                        <img src="img/adm-certificate-approval-4.png" class="tech-4" style="max-width: 100%" />
                        <img src="img/adm-certificate-approval-5.png" class="tech-5" style="max-width: 100%" />
                    <?php } ?>
                    ...
                    <script>
                        ...
                        $('.tech-4').on('click',function () {
                            $('.tech-5').css('display','initial');
                            $('.tech-4').css('display','none');
                        });

                        <?php if($_SESSION['role']==72){ ?>
                        $('.tech-6').css('display','none');
                        $('.tech-5').on('click',function () {
                            $('.tech-6').css('display','initial');
                            $('.tech-5').css('display','none');
                        });
                        $('.tech-6').on('click',function () {
