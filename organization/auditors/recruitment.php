        ...
        <div class='card mb-3'>
            <div class="row">
                <div class="col-12 text-center">
                    <img src="img/recruitment-1.png" class="tech-1" style="max-width: 100%"/>
                    <img src="img/recruitment-2.png" class="tech-2" style="max-width: 100%"/>
                    <img src="img/recruitment-3.png" class="tech-3" style="max-width: 100%"/>
                    <img src="img/recruitment-4.png" class="tech-4" style="max-width: 100%"/>
                    <img src="img/recruitment-5.png" class="tech-5" style="max-width: 100%"/>
                    <img src="img/recruitment-6.png" class="tech-6" style="max-width: 100%"/>
                    <img src="img/recruitment-7.png" class="tech-7" style="max-width: 100%"/>
                    <img src="img/recruitment-8.png" class="tech-8" style="max-width: 100%"/>
                    <script>
