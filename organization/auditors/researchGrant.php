...
<div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">Research Grant</li>
      </ol>
     </div>
        ...
        <div class='card mb-3'>
            ...
            <div class="row">
                <div class="col-12 text-center">
                    <img src="img/research-grant-adm.png" class="tech-1" style="max-width: 100%" />
                    <img src="img/research-grant-adm-popup.png" class="tech-2" style="max-width: 100%" />
                    <script>
