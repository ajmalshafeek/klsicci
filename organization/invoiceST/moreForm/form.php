...
function additionalForm($dateFrom,$dateTo,$reset){
  ...
  if ($reset) {
    ...
    <div class="col-md-12">
        <a href="viewInvoice.php" style="float:right;color:blue;"><i>Reset</i></a>
    </div>
    </div>
    ';
  }else {
  ...
  $form='
  <form action="https://'.$_SERVER["HTTP_HOST"].$config["appRoot"].'/organization/invoice/viewInvoice.php" method="post">
