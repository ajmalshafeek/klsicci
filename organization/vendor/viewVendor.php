  ...
  <form method="POST" action="<?php echo "https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/phpfunctions/vendor.php" ?>" >
    ...
    <div class="modal fade" id="vendorDeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="vendorDeleteModalTitle">VENDOR DETAILS</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div class="modal-body">
              ...
              <div id='staffDeleteContent' >
                  What action do you wish to do for the vendor
              </div>

            <div class="modal-footer">
              <input type="hidden"  name="vendorIdToDelete" id="vendorIdToDelete" value=""  />
                <button type="submit" name='editVendor' class="btn btn-primary" >Edit</button>
              <button type="submit" name='removeVendor' class="btn btn-primary" >Remove</button>
