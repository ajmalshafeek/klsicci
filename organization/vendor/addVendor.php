        ...
        <form method="POST" action="../../phpfunctions/vendor.php" class="needs-validation" novalidate >
          ...
          <div id="criteriaForm">
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10"   >
                <input type="text"  placeholder="Enter Vendor Contact No. " class="form-control" id="vendorContactNo" name="vendorContactNo" oninput="this.value = this.value.replace(/[^0-9.]/g, ''); this.value = this.value.replace(/(\..*)\./g, '$1');"></input>
              </div>
            </div>
