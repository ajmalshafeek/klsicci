...
$invoiceMailList=getInvoiceMailList($invoiceDetails['id']);
...
-->
           <div class="form-group row">
                ...
                <div class="col-sm-8"  >
                    <a href="<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot']."/organization/InvoiceC1/viewInvoiceC1.php"; ?>" class="btn btn-primary btn-lg " style="background-color:#2BADCA">CLOSE</a>
                </div>
                <div class="col-sm-2" >
