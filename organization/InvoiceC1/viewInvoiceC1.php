    ...
    */
    ...
    $('#invoiceListTable tbody').on('click', 'td', function () {
      ...
      //var path=<?php echo "'https://".$_SERVER['HTTP_HOST'].$config['appRoot']."'"; ?>+'/resources/'+<?php echo $_SESSION['orgId']; ?>+'/invoice/';
        var path=<?php echo "'https://".$_SERVER['HTTP_HOST'].$config['appRoot'].'/resources/'.$_SESSION['orgId'].'/InvoiceC1/'."'"; ?>;
      ...
      $.ajax({
            type  : 'GET',
            url  : '<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/phpfunctions/invoiceC1.php'; ?>',
...
<div class="content-wrapper">
    ...
    <?php echo shortcut() ?>
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item ">My Invoice</li>
  		 ...
  		 <div class='card mb-3 '  >
			<div class='card-header '>
              ...
              <div class='table-responsive'>
                <form action="<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot']."/phpfunctions/invoiceC1.php"; ?>" method="POST" >
                    <?php  if($role!=1){ ?>
                  <button type="submit" id="downloadSelectedFile" name="downloadSelectedInvoiceFile" class="btn"><i class="fa fa-download"></i> Download</button>
                    ...
                    if($role==0){
                      ...
                      $table=invoiceListTableC1(null,null,null,null,null,null,$dateFrom,$dateTo,null,$_SESSION['orgId']);
                    }else{
                        $table=invoiceListTableC1(null,null,null,null,null,$_SESSION['userid'],$dateFrom,$dateTo,null,$_SESSION['orgId']);
                    }
                      echo $table;
                    ?>
      ...
      <div class="modal-dialog modal-dialog-centered modal-full" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <object id="invoicePDFObject" data="<?php echo "https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/resources/2/InvoiceC1/0000000003.pdf"; ?>" frameborder="0" width="100%" height="400px" style="height: 85vh;">
                  <p>Your web browser doesn't have a PDF plugin.
                    Instead you can
                    <a id="invoicePDFAnchor" target="_blank" href="<?php echo "https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/resources/2/InvoiceC1/0000000003.pdf"; ?>">click here to
