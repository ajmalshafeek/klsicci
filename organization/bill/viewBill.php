  ...
  -->
    ...
    <script>
                    ...
                    $(document).ready(function() {
                        ...
                        var temp="Expense List "+dateTime;
                        $('#dtable').DataTable( {
                            dom: 'Bfrtip',
                            buttons: [
                                {
        ...
        function billEdit(str){

            $("#billIdToEdit").val(str.value);
...
<form method="POST" action="../../phpfunctions/bill.php" >
    ...
    <div class="modal fade" id="billEditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <input type="text" hidden name="billIdToEdit" id="billIdToEdit" value=""  />
                   <?php // <button type="submit" name='editBill' class="btn btn-primary" >Edit</button> ?>
                    <button type="submit" name='removeBill' class="btn btn-primary" >Remove</button>
