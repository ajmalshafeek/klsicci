...
?>
     ...
     function billCategoryEdit(str){

       $("#billCategoryIdToEdit").val(str.value);
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">View Expense Category</li>
    ...
    <div class="modal fade" id="billCategoryEditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <input type="text" hidden name="billCategoryIdToEdit" id="billCategoryIdToEdit" value=""  />
                <button type="submit" name='editBillCategory' class="btn btn-primary" >Edit</button>
                <button type="submit" name='removeBillCategory' class="btn btn-primary" >Remove</button>
