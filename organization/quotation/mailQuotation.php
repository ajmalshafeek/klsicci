...
if(!isset($_SESSION['quotationNumber'])){
...
<script>
    ...
    function getEmailSuggest(){
     /*   var str="true";
        $.ajax({
            type  : 'GET',
            url  : '<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/phpfunctions/mail.php'; ?>',
            data : {mailSuggestion:str,key:'jsoft'},
    ...
    (function() {
		...
		$(function() {
            ...
            <?php
                ...
                $ccAddress="\"\"";
                foreach($quotationMailList as $address){
                    if($address['type']=="TO"){
            ...
            <?php require_once($_SERVER['DOCUMENT_ROOT'].$config['appRoot']."/phpfunctions/configurationApp.php"); ?>
            $("#quotationMailAddress").val('[<?php echo $toAddress; ?>]');
           // $("#quotationMailAddressCC").val('[<?php echo $ccAddress; ?>,"<?php echo getCCEmailId(); ?>"]');
            $("#quotationMailAddressCC").val('[<?php echo $ccAddress; ?>');
            $('#mailQuotation').click(function () {
			...
			$('#quotationMailAddress').multiple_emails({theme: "Basic"});

            $('#quotationMailAddressCC').multiple_emails({theme: "Basic"});
...
<div class="content-wrapper" >
    ...
    <?php echo shortcut() ?>
      ...
      <ol class="breadcrumb col-md-12">
		...
		<a href="#">QUOTAION & INVOICE </a>

        </li>

        <li class="breadcrumb-item ">QUOTATION</li>
		<li class="breadcrumb-item active">MAIL QUOTATION</li>
      </ol>
    </div>
	  ...
	  <?php
        ...
        ?>
            <div class="col-12">
                ...
                <h1  style="text-align:center; font-family:brush script mt;">Mail This Quotation</h1>
            ...
            <form  action="<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot']."/phpfunctions/mail.php"; ?>"
                ...
                <div class="form-group row">
                    <label for="quotationMailAddress" class="col-sm-1 col-form-label col-form-label-lg">TO</label>

                    <div class="col-sm-10" id="toAddressDiv">
                    <input type='text' id='quotationMailAddress' name='quotationMailAddress' class='form-control' style="padding:10px;" required >
                ...
                <div class="form-group row">
                    <label for="quotationMailAddressCC" class="col-sm-1 col-form-label col-form-label-lg">CC</label>
                    <div class="col-sm-10"   >

                    <input type='text' id='quotationMailAddressCC' name='quotationMailAddressCC' value="[]" class='form-control' style="padding:10px;">
                        <div class="invalid-feedback">
                        Please enter email address to send
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10"   >
                    <input type='text'  class='form-control' name="subject" value='QUOTATION-#<?php echo $_SESSION['quotationNumber']; ?>' id="subject">
...
style="height: 200px;border: 1px solid #ccc;overflow: scroll;background-color:#EEFAFB    "
                    ...
                    <?php
                            ...
                            $quoMailBody=str_replace("[Customer_Attention]",$quotationDetails['attention'],$quoMailBody);
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8"  >
                            <a href="<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot']."/organization/quotation/viewQuotation.php"; ?>" class="btn btn-primary btn-lg " style="background-color:#2BADCA">CLOSE</a>
                        </div>
                        <div class="col-sm-2" style="text-align:right">
                            <button type="submit" id="mailQuotation" name="mailQuotation" class="btn btn-primary btn-lg btn-block" >SEND</button>
