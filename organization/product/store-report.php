      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <div class="form-group" id="assignto">
                ...
                <select name='workerType' class='form-control' id='workerType' onchange="changeWorkType(this.value)" required="required">
          ...
          <button type="submit" name='updateStoreOrder' class="btn btn-primary" id="loadBtn" class="updateStatus"
