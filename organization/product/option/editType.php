        ...
        <form method="POST" action="../../../phpfunctions/product.php" class="needs-validation" novalidate >
            ...
            <div id="criteriaForm">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10"   >
                        <input type="text" value="<?php echo $idEdit ?>"  class="form-control" id="productTypeId" name="productTypeId" required disabled />
                        <input type="text" value="<?php echo $idEdit ?>"  class="form-control" id="productTypeId" name="productTypeId" hidden />
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10"   >
                        <input type="text" value="<?php echo $productType ?>"  class="form-control" id="productType" name="productType" required />
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <button name='editProductTypeProcess' class="btn btn-primary btn-lg btn-block" type='submit' style="text-align: center;">SUBMIT</button>
                    </div>
                </div>
