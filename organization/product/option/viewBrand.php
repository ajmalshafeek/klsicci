...
?>
     ...
     function brandEdit(str){

       $("#brandIdToEdit").val(str.value);
...
<!--
  ...
  <div class="modal fade" id="staffDeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <div class="modal fade" id="brandEditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="brandEditModalTitle">ACTIONS</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              ...
              <div class="modal-footer">
                <input type="text" hidden name="brandIdToEdit" id="brandIdToEdit" value=""  />
                <button type="submit" name='editBrand' class="btn btn-primary" >Edit</button>
                <button type="submit" name='removeBrand' class="btn btn-primary" >Remove</button>
