          ...
          <?php
            ...
            <div id="criteriaForm">
              <div class="form-group row">
                ...
                <div class="col-sm-10"   >
                  <input type="text" placeholder="Enter Brand Name"  class="form-control" id="brandName" name="brandName" required></input>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <button name='addBrand' class="btn btn-primary btn-lg btn-block" type='submit' style="text-align: center;">SUBMIT</button>
                  </div>
              </div>
