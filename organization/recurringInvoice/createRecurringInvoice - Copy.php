		...
		<div class="container">
			...
			<div class="tab-content" id="pills-tabContent">
				...
				<div class="tab-pane fade show active " id="pills-clientDetails" role="tabpanel" aria-labelledby="pills-clientDetails-tab">
                    ...
                    <div class="form-group row">
                        <label for="recurringDate" class="col-sm-2 col-form-label col-form-label-lg">Recurring Date:</label>
                        <div class="col-sm-4">

                            <input type="date" class="form-control required" placeholder="Recurring Date" id="recurringDate" name="recurringDate" required />
                        ...
                        <label for="recurringFormat" class="col-sm-2 col-form-label col-form-label-lg">Recurring Format:</label>
                        <div class="col-sm-4">

                            <select name="recurringFormat"  class="form-control" id="recurringFormat" required>
                                <option selected disabled value="">--Select--</option>
