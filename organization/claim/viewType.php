...
?>
     ...
     function claimTypeEdit(str){

       $("#claimTypeIdToEdit").val(str.value);
  ...
  <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">View Claim Request Type</li>
    ...
    <form method="POST" action="../../phpfunctions/claim.php" >

    <div class="modal fade" id="claimTypeEditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <input type="text" hidden name="claimTypeIdToEdit" id="claimTypeIdToEdit" value=""  />
                <button type="submit" name='editClaimType' class="btn btn-primary" >Edit</button>
                <button type="submit" name='removeClaimType' class="btn btn-primary" >Remove</button>
