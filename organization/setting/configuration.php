		...
		<form method="POST" action="../../phpfunctions/organizationUser.php" class="needs-validation" novalidate >
			...
			<div id="criteriaForm">
				<div class="form-group row">
					...
					<div class="col-sm-10"   >
						<input type="text" placeholder="Enter Staff Name"  class="form-control" id="staffName" name="staffName" required></input>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10"   >
						<input type="text" placeholder="Enter Staff ID "  class="form-control" id="staffId" name="staffId" required></input>
						<div class="invalid-feedback">
				...
				<div class="form-group row">
					<label for="staffIC" class="col-sm-2 col-form-label col-form-label-lg">IC No./Passport No.</label>
					<div class="col-sm-10"   >
						<input type="text" placeholder="Enter IC Number/Passport Number"  class="form-control" id="staffIc" name="staffIc" required></input>
						<div class="invalid-feedback">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10"   >
						<input type="email"  placeholder="Enter Staff Email" required class="form-control" id="staffEmail" name="staffEmail" ></input>
						<div class="invalid-feedback">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10"   >
						<input type="number"  placeholder="Enter Staff Phone" required class="form-control" id="staffPhone" name="staffPhone" ></input>
						<div class="invalid-feedback">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10"   >
						<input type="date" placeholder=""  class="form-control" id="staffStart" name="staffStart" required></input>
						<div class="invalid-feedback">
