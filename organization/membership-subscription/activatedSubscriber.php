    ...
    <div class="container-fluid">
      ...
      <?php
        ...
        <div class='card mb-3'>
          ...
          <?php
          approvedMemberRequestListTable();
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id='staffEditContent' >
                        What action do you wish to do for the membership?
                    </div>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" data-toggle='modal' data-target='#removeNewClientModel' class="btn btn-primary edit" >Terminate Account</button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <!-- <button type="submit" name='addNewClient' class="btn btn-primary edit" value="0" >Add potential Client </button> -->
                        <button type="submit" name='updateActivatedMembershipStatus' id="activate" class="btn btn-primary edit" value="1" >Activate</button>
                        <button type="submit" name='updateActivatedMembershipStatus' id="deactivate" class="btn btn-primary edit" value="0" >De-Activate</button>
                        <button type="button" class="btn btn-secondary remove" data-dismiss="modal">CANCEL</button>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        ...
                        <!-- <button type="submit" name='addNewClient' class="btn btn-primary edit" value="0" >Add potential Client </button> -->
                        <button type="submit" name='updateActivatedPaymentStatus' id="payed" class="btn btn-primary edit" value="1" >Paid</button>
                        <button type="submit" name='updateActivatedPaymentStatus' id="pending" class="btn btn-primary edit" value="0" >Unpaid</button>
                        <button type="button" class="btn btn-secondary remove" data-dismiss="modal">CANCEL</button>
                    </div>
                </div>
            </div>
...
<form method="POST" action="<?php echo "https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/organization/membership-subscription/terminateAccount.php" ?>" >
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div id='staffEditContent' >
                        Are you sure want to Terminate Account?
                    </div>
                </div>
                <div class="modal-footer">
                    <input type="text" hidden name="clientIdToEdit" class="clientIdToEdit" value=""  />
                    <button type="submit" name='terminateAccount' class="btn btn-primary edit" >Yes</button>
