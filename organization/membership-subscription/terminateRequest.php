...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb col-md-12">
            ...
            <li class="breadcrumb-item ">Terminate Account Request</li>
            <li class="breadcrumb-item active">View Terminate Request</li>
        </ol>
    </div>
...
<form method="POST" action="<?php echo "https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/phpfunctions/subscriber.php" ?>" >
    ...
    <div class="modal fade" id="removeNewClientModel" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="productTypeEditModalTitle">TERMINATE ACTION</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name='removeAccount' class="btn btn-primary edit" >Yes</button>
