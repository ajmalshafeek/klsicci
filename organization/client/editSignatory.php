...
$idEdit=$_SESSION['signatoryIdEdit'];
$position=$_SESSION['positionEdit']
?>
<!DOCTYPE html >
 ...
 <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">Edit Signatory</li>
          ...
          <?php
            ...
            <div id="criteriaForm">
              ...
              <div class="form-group row">
                <label for="signatoryId" class="col-sm-2 col-form-label col-form-label-lg">ID</label>
                <div class="col-sm-10"   >
                  <input type="text" value="<?php echo $idEdit ?>"  class="form-control" id="signatoryId" name="signatoryId" required></input>
                <div class="invalid-feedback">
                  Please enter signatory id
                </div>
                </div>
              </div>
              ...
              <div class="form-group row">
                <label for="name" class="col-sm-2 col-form-label col-form-label-lg">Signatory Name</label>
                <div class="col-sm-10"   >
                  <input type="text" value="<?php echo $name ?>"  class="form-control" id="name" name="name" required></input>
                <div class="invalid-feedback">
                ...
                <div class="col-sm-10"   >
                  <input type="text" value="<?php echo $position ?>"  class="form-control" id="position" name="position" required></input>
                <div class="invalid-feedback">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <button name='editSignatoryProcess' class="btn btn-primary btn-lg btn-block" type='submit' style="text-align: center;">SUBMIT</button>
                  </div>
              </div>
