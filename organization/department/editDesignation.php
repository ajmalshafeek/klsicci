...
$designation=$_SESSION['designationEdit'];
$idEdit=$_SESSION['designationIdEdit'];
        ...
        <form method="POST" action="../../phpfunctions/organizationUser.php" class="needs-validation" novalidate >
            ...
            <div id="criteriaForm">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10"   >
                        <input type="text" value="<?php echo $idEdit ?>"  class="form-control" id="designationId" name="designationId" required />
                ...
                <div class="form-group row">
                    <label for="designationName" class="col-sm-2 col-form-label col-form-label-lg">Name</label>
                    <div class="col-sm-10"   >
                        <input type="text" value="<?php echo $designation ?>"  class="form-control" id="designationName" name="designationName" required />
	                    <input type="hidden" value="<?php echo $designation ?>"  class="form-control" id="designationName" name="designation" required />
                        <div class="invalid-feedback">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <button name='editDesignationProcess' class="btn btn-primary btn-lg btn-block" type='submit' style="text-align: center;">SUBMIT</button>
                    </div>
                </div>
