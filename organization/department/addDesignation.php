        ...
        <form method="POST" action="../../phpfunctions/organizationUser.php" class="needs-validation" novalidate >
            ...
            <div id="criteriaForm">
                <div class="form-group row">
                    ...
                    <div class="col-sm-10"   >
                        <input type="text" placeholder="Enter Designation"  class="form-control" id="designation" name="designation" required></input>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <button name='addDesignation' class="btn btn-primary btn-lg btn-block" type='submit' style="text-align: center;">SAVE</button>
                    </div>
                </div>
