...
$idEdit=$_SESSION['departmentIdEdit'];
?>
<!DOCTYPE html >
          ...
          <?php
            ...
            <div id="criteriaForm">
              ...
              <div class="form-group row">
                <label for="departmentId" class="col-sm-2 col-form-label col-form-label-lg">ID</label>
                <div class="col-sm-10"   >
                  <input type="text" value="<?php echo $idEdit ?>"  class="form-control" id="departmentId" name="departmentId" required></input>
              ...
              <div class="form-group row">
                <label for="departmentName" class="col-sm-2 col-form-label col-form-label-lg">Name</label>
                <div class="col-sm-10"   >
                  <input type="text" value="<?php echo $name ?>"  class="form-control" id="departmentName" name="departmentName" required></input>
                <div class="invalid-feedback">
                 ...
                 <div class="form-group row">
                  ...
                  <div class="col-sm-10">
                      <button name='editDepartmentProcess' class="btn btn-primary btn-lg btn-block" type='submit' style="text-align: center;">SUBMIT</button>
                  </div>
              </div>
