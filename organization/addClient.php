            ...
            <div class="form-group row">
              ...
              <label for="clientContactNo" class="col-sm-2  col-form-label col-form-label-lg">PHONE NO.</label>
                <div class="col-sm-10"   >
                    ...
                    <input type="text" class="form-control" placeholder="xx-xxx xxxx"  id="orgContactNo" name="orgContactNo" ></input>
                    <div class="invalid-feedback">
              ...
              <div class="form-group row">
                <label for="clientFaxNo" class="col-sm-2  col-form-label col-form-label-lg">FAX NO.</label>
                  <div class="col-sm-10"   >
                    ...
                    <input type="text" class="form-control" placeholder="xx-xxx xxx"  id="orgFaxNo" name="orgFaxNo" ></input>
                    <div class="invalid-feedback">
