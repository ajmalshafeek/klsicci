 ...
 session_name($config['sessionName']);
   session_start();
    ...
    if(!isset($_POST['uid']) && empty($_POST['uid'])){
        header('Location: pendingCountLeaves.php');
    }
}
?>
<!DOCTYPE html >
 ...
 <div class="content-wrapper">
    <div class="container-fluid">
      ...
      <ol class="breadcrumb col-md-12">
        ...
        <li class="breadcrumb-item active">Staff Leave Update</li>
      </ol>
      </div>
     <div class="container-fluid">
         <div class="pd-20 card-box mb-30">
             <div class="clearfix">
                 <div class="pull-left">
                     <h4 class="text-blue h4">Staff Leave Update Application</h4>
                     <p class="mb-20"></p>
                 </div>
             </div>
             <form method="post" action="../../phpfunctions/applyLeave.php">
                 <?php
                     $lid=$_POST['uid'];
                     $leaveOrg=getLeaveOrgInfo($lid);
                 ?>
             <div class="row">
                 <div class="col-md-12 col-sm-12">
                     <div class="form-group">
                         <label>Staff Name</label>
                         <input name="fullname" type="text" class="form-control wizard-required" autocomplete="off" value="<?php echo $leaveOrg['fullName']; ?>" disabled />
                     </div>
                 </div>
             </div>
                 <div class="row">
                     <div class="col-md-6 col-sm-12">
                         <div class="form-group">
                             ...
                             <input name="fullname" type="text" class="form-control wizard-required" autocomplete="off" value="<?php echo $leaveOrg['staffId']; ?>" disabled />
                         </div>
                     </div>
                     <div class="col-md-6 col-sm-12">
                         <div class="form-group">
                             <label>Designation</label>
                             <input name="department" type="text" class="form-control wizard-required" autocomplete="off" value="<?php echo $leaveOrg['staffDesignation']; ?>"  disabled />
                         </div>
                     </div>
                 </div>
                 <div class="row">
                     <div class="col-md-6 col-sm-12">
                         <div class="form-group">
                             ...
                             <input name="al_entitle" type="number" step=0.5 class="form-control wizard-required" autocomplete="off" value="<?php echo $leaveOrg['al_entitle']; ?>" required />
                         </div>
                     </div>
                     <div class="col-md-6 col-sm-12">
                         <div class="form-group">
                             <label>Medical Leave</label>
                             <input name="mc_entitle" type="number" step="0.5" class="form-control wizard-required" autocomplete="off" value="<?php echo $leaveOrg['mc_entitle']; ?>" required />
                         </div>
                     </div>
                 </div>
                 <div class="row">
                     <div class="col-md-12 col-sm-12">
                         <div class="form-group">
                             ...
                             <div class="modal-footer justify-content-center">
                                 ...
                                 <button class="btn btn-primary" name="updateStaffleave" id="updateStaffleave" data-toggle="modal">Update Leaves</button>
                             </div>
                         </div>
                     </div>
                 </div>
