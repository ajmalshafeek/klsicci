			...
			<div class="tab-content" id="pills-tabContent">
				...
				<div class="tab-pane fade show active " id="pills-clientDetails" role="tabpanel" aria-labelledby="pills-clientDetails-tab">
                    ...
                    <div class="form-group row">
						<label class="col-sm-2 col-form-label col-form-label-lg"></label>
						<div class="col-sm-10 custom-checkbox-lg">
							<label for="pref" class="col-form-label col-form-label-lg">Required D/O TERM </label>
					...
					<div class="form-group row prefstatus" style="display:none">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control" placeholder="D/O Term" id="prefnumber" name="prefnumber" />

							<div class="invalid-feedback">
								Please Enter D/O Term
							</div>
