...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  -->
    ...
    <script>
        ...
        function eaOfficerEdit(str){

            $("#officerIdToEdit").val(str.value);
...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb col-md-12">
            ...
            <li class="breadcrumb-item active">View EA Officer Details</li>
    ...
    <div class='card mb-3'>
        ...
        <div class='card-body'>
            <?php
	            eaOfficerDetailsListTableEditable();
            ?>
    ...
    <div class="modal fade" id="designationEditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <input type="text" hidden name="officerIdToEdit" id="officerIdToEdit" value=""  />
                    <button type="submit" name='editOfficerDetails' class="btn btn-primary" >Edit</button>
                    <button type="submit" name='removeOfficerDetails' class="btn btn-primary" >Remove</button>
