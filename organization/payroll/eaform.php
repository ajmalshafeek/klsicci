				...
				<div class="tab-pane fade show active" id="pills-staff" role="tabpanel" aria-labelledby="pills-staff-tab">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control required" placeholder="position name" id="position" name="position" required />
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control required" placeholder="staff number" id="staffNum" name="staffNum" required />
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control required" placeholder="IC number" id="icNum" name="icNum" required />
                    ...
                    <div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control required" placeholder="passport number" id="passNum" name="passNum" required />
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control required" placeholder="perkeso number" id="perkesoNum" name="perkesoNum" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" class="form-control required" placeholder="KWSP number" id="kwspNum" name="kwspNum" />
						<div class="invalid-feedback">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="date" class="form-control required" placeholder="Start Date" id="startDate" name="startDate"  />
							<div class="invalid-feedback">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="date" class="form-control required" placeholder="End Date" id="endDate" name="endDate"  />
							<div class="invalid-feedback">
				...
				<div class="tab-pane fade " id="pills-income" role="tabpanel" aria-labelledby="pills-income-tab">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="gross salary (RM)" id="grossSalary" name="grossSalary" onchange="checkValue(this)" step="0.01" min="0.00"  />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="Fi, Commisen or Bonus (RM)" id="fiBonus" name="fiBonus" onchange="checkValue(this)" step="0.01" min="0.00" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control required" placeholder="Allowance for" id="payFor" name="payFor"  />
							<div class="invalid-feedback">
						...
						<div class="col-sm-4">
							<input type="number" class="form-control required" placeholder="Allowence (RM)" id="payAmount" name="payAmount" onchange="checkValue(this)" step="0.01" min="0.00" />
							<div class="invalid-feedback">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="Tax Paid by Employer (RM)" id="taxByEmployer" name="taxByEmployer" onchange="checkValue(this)" step="0.01" min="0.00" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="ESOS (RM)" id="esos" name="esos" onchange="checkValue(this)" step="0.01" min="0.00" />
					...
					<fieldset><legend>(f) Reward</legend><div>
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="date" class="form-control required" placeholder="Reward From" id="rewardFrom" name="rewardFrom"  />
									<div class="invalid-feedback">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="date" class="form-control required" placeholder="Reward To" id="rewardTo" name="rewardTo"  />
									<div class="invalid-feedback">
					...
					<fieldset><legend>2. Details of Pending Payments</legend><div>
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control required" placeholder="Previous Year" id="previousYear" name="previousYear" />
									<div class="invalid-feedback">
							...
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control required" placeholder="Current Year" id="currentYear" name="currentYear" />
									<div class="invalid-feedback">
					...
					<div class="form-group row mt-3">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control required" placeholder="State" id="benefitsState" name="benefitsState"  />
							<div class="invalid-feedback">
								Please Enter State
							</div>
						...
						<div class="col-sm-4">
							<input type="number" class="form-control required" placeholder="Amount (RM)" id="benefitsAmount" name="benefitsAmount" onchange="checkValue(this)" step="0.01" min="0.00" />
							<div class="invalid-feedback">
								Please Enter Amount
							</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-4">
							<input type="text" class="form-control required" placeholder="Address" id="resiAdd" name="resiAdd"  />
							<div class="invalid-feedback">
						...
						<div class="col-sm-4">
							<input type="number" class="form-control required" placeholder="Value (RM)" id="resiValue" name="resiValue" onchange="checkValue(this)" step="0.01" min="0.00" />
							<div class="invalid-feedback">
								Please Enter Value
							</div>
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="Refund from KWSP(RM)" id="refundKWSP" name="refundKWSP" onchange="checkValue(this)" step="0.01" min="0.00" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="Reparation Job(RM)" id="reparationJob" name="reparationJob" onchange="checkValue(this)" step="0.01" min="0.00" />
...
<br />
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="Pension (RM)" id="pensionAmount" name="pensionAmount" onchange="checkValue(this)" step="0.01" min="0.00" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="Amount (RM)" id="annuitAmount" name="annuitAmount" onchange="checkValue(this)" step="0.01" min="0.00" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="Amount (RM)" id="totalPension" name="totalPension" onchange="checkValue(this)" step="0.01" min="0.00" />
				...
				<div class="tab-pane fade " id="pills-deduction" role="tabpanel" aria-labelledby="pills-deduction-tab">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="Amount (RM)" id="pcbAmount" name="pcbAmount" onchange="checkValue(this)" step="0.01" min="0.00" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="Amount (RM)" id="deductionCP" name="deductionCP" onchange="checkValue(this)" step="0.01" min="0.00" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="Amount (RM)" id="zakatAmount" name="zakatAmount" onchange="checkValue(this)" step="0.01" min="0.00" />
					...
					<fieldset><legend>4. Total Deduction claim by employee through TP1 Form:</legend><div>
							<div class="form-group row">
								<label for="deductionTP1a" class="col-sm-4 col-form-label col-form-label-lg">a) Release</label>
								<div class="col-sm-8">

									<input type="number" class="form-control required" placeholder="Amount (RM)" id="deductionTP1a" name="deductionTP1a" onchange="checkValue(this)" step="0.01" min="0.00" />
							...
							<div class="form-group row">
								<label for="deductionTP1b" class="col-sm-4 col-form-label col-form-label-lg">b) Zakat paid via monthly salary deduction</label>
								<div class="col-sm-8">

									<input type="number" class="form-control required" placeholder="Amount (RM)" id="deductionTP1b" name="deductionTP1b" onchange="checkValue(this)" step="0.01" min="0.00" />
					...
					<div class="form-group row mt-3">
						<label for="jumlahPele" class="col-sm-4 col-form-label col-form-label-lg">6. Total release for eligible children:</label>
						<div class="col-sm-8">

							<input type="number" class="form-control required" placeholder="Amount (RM)" id="jumlahPele" name="jumlahPele" onchange="checkValue(this)" step="0.01" min="0.00" />
				...
				<div class="tab-pane fade " id="pills-epf" role="tabpanel" aria-labelledby="pills-epf-tab">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<input type="text" class="form-control required" placeholder="fund name" id="fundName" name="fundName" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="Amount (RM)" id="contribution" name="contribution" onchange="checkValue(this)" step="0.01" min="0.00" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required" placeholder="Amount (RM)" id="perkesoPaidAmount" name="perkesoPaidAmount" onchange="checkValue(this)" step="0.01" min="0.00" />
				...
				<div class="tab-pane fade " id="pills-allowances" role="tabpanel" aria-labelledby="pills-allowances-tab">
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="number" class="form-control required totalAllowances" placeholder="Amount (RM)" id="totalAllowances" name="totalAllowances" onchange="checkValue(this)" step="0.01" min="0.00"/>
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="text" class="form-control required" placeholder="Officer Position" id="officerPosition" name="officerPosition" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="text" class="form-control required" placeholder="Employer Name and Address" id="employerNameAdd" name="employerNameAdd" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="text" class="form-control required" placeholder="Employer Telephone Number" id="employerNum" name="employerNum" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<input type="Date" class="form-control required" placeholder="Date" id="date" name="date" />
					...
					<div class="form-group row">
						...
						<div class="col-sm-8">
							...
							<select class="form-control required" placeholder="year" id="year" name="year" />
							<?php
							$date=(int)Date("Y");
								for($i=9;$i>-1;$i--){
					...
					<div class="form-group row">
						...
						<div class="col-sm-10" style="text-align:right">
							...
							<button type="submit" id="" class="btn btn-primary btn-lg mt-3" name="SaveEAForm" type='button' value="1">DRAFT</button>
							<button type="submit" id="" class="btn btn-primary btn-lg mt-3" name="SaveEAForm" type='button' value="0">SUBMIT</button>
						</div>
					</div>
				</div>
