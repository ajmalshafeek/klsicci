...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <ol class="breadcrumb col-md-12">
            ...
            <li class="breadcrumb-item ">Trip Report</li>
        </ol>
    </div>
    <div class="container">
        <form method="POST" action="../../phpfunctions/trip.php" class="needs-validation">
            ...
            <div class="form-group row">
                <div class="col-md-12">
                    <button class="btn btn-primary btn-lg btn-block" type="submit" name="tripReport">Search</button>
                </div>
            </div>
        </form>
...
<script>
    ...
    function viewDetails(sclass,tripId){
        let mdate=document.getElementsByClassName(sclass)[0].getElementsByTagName("td");
        $('.detail').html("");
        $.ajax({
            type  : 'GET',
            url  : '../../phpfunctions/trip.php?',
            data : {tripExpenses:tripId},
