...
require_once($_SERVER['DOCUMENT_ROOT'].$config['appRoot']."/phpfunctions/orgJobList.php");

require_once($_SERVER['DOCUMENT_ROOT'].$config['appRoot']."/phpfunctions/job.php");

require_once($_SERVER['DOCUMENT_ROOT'].$config['appRoot']."/organization/staff/moreForm/form.php");
...
<div class="container">
      ...
      <form id="mainForm" method="POST" action=<?php echo "https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/phpfunctions/job.php" ?> class="needs-validation" novalidate >
...
<?php } ?>
	...
	<?php if($_SESSION['staffRole']!=true) {  ?>
      <div class="form-group row">
...
<!--(END)SIGNATURE-->
	      <?php } ?>
	      <?php if(isset($_SESSION['staffCam'])&& $_SESSION['staffCam']==1){ ?>
          ...
          <div class="form-group row">
              ...
              <?php
               ...
               if (isset($_POST['updateAssignedTask'])||(isset($_POST['updateAssignedTaskRemarks']))) {
                ...
                <button onclick="checkSubmit()" name="updateAssignedMyTaskOrgStaff"  class="btn btn-primary btn-lg btn-block" type='button' >SUBMIT</button>

                <input id="submitForm" type="submit" name="updateAssignedMyTaskOrgStaff" hidden>
