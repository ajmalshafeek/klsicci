...
?>
     ...
     function staffEdit(str){

       $("#staffIdToEdit").val(str.value);
       $(".staffIdToEdit").val(str.value);
    ...
    <div class="container-fluid">
      ...
      <?php
        ...
        <div class='card mb-3'>
          ...
          <div class='card-body'>
          <?php
          organizationStaffListTableEditable(); 
          organizationStaffListTableDownload(); //for excel
          ?>
    ...
    <div class="modal fade" id="staffEditModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
          <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                <input type="text" hidden name="staffIdToEdit" id="staffIdToEdit" value=""  />
                <button type="submit" name='editStaff' class="btn btn-primary edit" >Edit</button>
                  <button type="button" data-toggle='modal' data-target='#staffDeleteModal' class="btn btn-primary remove" >Remove</button>
    ...
    <div class="modal fade" id="staffDeleteModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <input type="text" hidden name="staffIdToEdit" class="staffIdToEdit" value=""  />
                    <button type="submit" name='removeStaff' class="btn btn-primary edit" >Yes</button>
