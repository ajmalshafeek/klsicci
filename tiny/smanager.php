    ...
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-sm <?php echo $tableTheme; ?>" id="main-table">
            ...
            foreach ($folder as $list) {
                $fname="";
            if(empty($_GET["p"])||!isset($_GET["p"])){
                if(!is_dir($path."/".$list['path'])){continue;}
                $f=$list['path'];
                $temp_name=explode($list['path']);
                $temp_size= sizeof($temp_name);
                $fname=$temp_name[$temp_size-1];
                echo "tis:".$path . '/' . $f;
               // echo $is_link = is_link($path . '/' . $f);

            }
            else{
                $f=$list;
                $fname= fm_convert_win(fm_enc($f));
            }
                ...
                <tr>
                    ...
                    <td>
                        <div class="filename"><a href="?p=<?php echo urlencode(trim(FM_PATH . '/' . $f, '/')) ?>"><i class="<?php echo $img ?>"></i> <?php echo $fname ?>
        ...
        <div class="col-xs-12 col-sm-9">
            <ul class="list-inline footer-action">
                ...
                <li class="list-inline-item"><input type="submit" class="hidden" name="tar" id="a-tar" value="tar" onclick="return confirm('<?php echo lng('Create archive?'); ?>')">
                    <a href="javascript:document.getElementById('a-tar').click();" class="btn btn-small btn-outline-primary btn-2 btn-color6"><i class="fa fa-file-archive-o"></i> <?php echo lng('Tar') ?> </a></li>
