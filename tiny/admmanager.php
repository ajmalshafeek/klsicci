...
$root_path = $_SERVER['DOCUMENT_ROOT'].$config['appRoot']."/resources/files";
...
$root_url = $config['appRoot']."/resources/files/";
...
// mail form POST
if (isset($_POST['mail']) && !FM_READONLY) {
    $copy_files = isset($_POST['file']) ? $_POST['file'] : null;
    if (!is_array($copy_files) || empty($copy_files)) {
        fm_set_msg(lng('Nothing selected'), 'alert');
        fm_redirect(FM_SELF_URL . '?p=' . urlencode(FM_PATH));
    ...
    <div class="path">
        <div class="card <?php echo fm_get_theme(); ?>">
            ...
            <div class="card-body">
                <form action="<?php //echo $config['appRoot']."/phpfunctions/fm.php"; ?>" method="post">
                    <input type="hidden" name="p" value="<?php echo fm_enc(FM_PATH) ?>">
                    <input type="hidden" name="finish" value="1">
                    <br class="break-word">Client's Notification Email:</br>
                    <?php
                    require_once ($_SERVER['DOCUMENT_ROOT'].$config['appRoot']."/phpfunctions/fm.php");
                    $emailList=getFolderClientEmails();
                    foreach ($copy_files as $cf) {
                        foreach ($emailList as $eml){
                            if(strcmp($cf,$eml['path'])==0){
                                echo "<b>".$cf."</b>=><i>".$eml['email']."</i><br>";
                                echo '<input type="hidden" name="email[]" value="' . $eml['email'] . '">' . PHP_EOL;
                            }else{
                                continue;
                            }
                        }
...
if(isset($_POST['emailsend'])){
    ...
    $body="Hi Sir/Ma'am, <br><br>Document Update Required or folder update new document.";
    ob_start();
        ...
        <table class="table table-bordered table-hover table-sm <?php echo $tableTheme; ?>" id="main-table">
                ...
                <tr>
                    ...
                    <td data-sort="a-<?php echo $modif_raw;?>"><?php echo $modif ?></td>
                        ...
                        <td><?php if (!FM_READONLY): ?>
                                <a title="Change Permissions" href="?p=<?php echo urlencode(FM_PATH) ?>&amp;chmod=<?php echo urlencode($f) ?>">
                                    <?php echo $perms ?></a>
                            <?php else: ?>
                                <?php echo $perms ?>
                            <?php endif; ?>
            ...
            if (empty($folders) && empty($files)) {
                ...
                <tfoot>
                    <tr><?php if (!FM_READONLY): ?>
                            <td></td><?php endif; ?>
                        <td colspan="<?php echo (!FM_IS_WIN && !$hide_Cols) ? '6' : '3' ?>"><em><?php echo 'Folder is empty' ?></em></td>
                    </tr>
                </tfoot>
                <?php
            } else {
                ...
                <tfoot>
                    <tr><?php if (!FM_READONLY): ?>
                        ...
                        <td class="gray" colspan="<?php echo (!FM_IS_WIN && !$hide_Cols) ? '6' : '3' ?>">
    ...
    <div class="row">
        ...
        <div class="col-xs-12 col-sm-9">
            <ul class="list-inline footer-action">
                ...
                <li class="list-inline-item"><a href="#/unselect-all" title="Make current selected unselected items" class="btn btn-small btn-outline-primary btn-2 btn-color2" onclick="unselect_all();return false;"><i class="fa fa-window-close"></i> <?php echo lng('UnSelectAll') ?> </a></li>
                <li class="list-inline-item"><a href="#/invert-all" title="Make current selected unselected items and unselected to selected" class="btn btn-small btn-outline-primary btn-2 btn-color3" onclick="invert_all();return false;"><i class="fa fa-th-list"></i> <?php echo lng('InvertSelection') ?> </a></li>
                <li class="list-inline-item"><input type="submit" class="hidden" name="delete" id="a-delete" value="Delete" onclick="return confirm('<?php echo lng('Delete selected files and folders?'); ?>')">
                    <a href="javascript:document.getElementById('a-delete').click();" class="btn btn-small btn-outline-primary btn-2 btn-color4"><i class="fa fa-trash"></i> <?php echo lng('Delete') ?> </a></li>
                ...
                <?php /* <li class="list-inline-item"><input type="submit" class="hidden" name="tar" id="a-tar" value="tar" onclick="return confirm('<?php echo lng('Create archive?'); ?>')">
                    <a href="javascript:document.getElementById('a-tar').click();" class="btn btn-small btn-outline-primary btn-2"><i class="fa fa-file-archive-o"></i> <?php echo lng('Tar') ?> </a></li> */ ?>
                <li class="list-inline-item"><input type="submit" class="hidden" name="copy" id="a-copy" value="Copy">
                    <a href="javascript:document.getElementById('a-copy').click();" class="btn btn-small btn-outline-primary btn-2 btn-color6"><i class="fa fa-files-o"></i> <?php echo lng('Copy') ?> </a></li>
                <li class="list-inline-item"><input type="submit" class="hidden" name="mail" id="a-mail" value="mail">
                    <a href="javascript:document.getElementById('a-mail').click();" class="btn btn-small btn-outline-primary btn-2 btn-color7"><i class="fa fa-envelope-o"></i> E-Mail </a></li>
            </ul>
        </div>
        <?php /* ajmal
...
<head>
    ...
    <style>
        ...
        * { -webkit-border-radius:0 !important;-moz-border-radius:0 !important;border-radius:0 !important; }
        ...
        form.dropzone { min-height:200px;border:2px dashed #cc0000;line-height:6rem; }
        ...
        i.fa.fa-file-code-o { color:#cc0000 }
        i.fa.fa-code { color:#cc4b4c }
        i.fa.fa-file-text-o { color:#0096e6 }
        i.fa.fa-html5 { color:#d75e72 }
        i.fa.fa-file-excel-o { color:#09c55d }
        i.fa.fa-file-powerpoint-o { color:#f6712e }
        i.go-back { font-size:1.2em;color:#cc0000; }
        ...
        .lds-facebook div { position:absolute;left:6px;width:13px;background:#cc0000;animation:lds-facebook 1.2s cubic-bezier(0,.5,.5,1) infinite }
