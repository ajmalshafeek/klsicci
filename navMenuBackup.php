      ...
      <ul class="sidenav-second-level collapse" id="jobsheet">
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Complaint">
          <a class="nav-link nav-link-collapse collapsed li-nav-style" data-toggle="collapse" href="#collapseComplaint" data-parent="#exampleAccordion">
            ...
            <span class="nav-link-text " >Complaints
          ...
          <ul class="sidenav-second-level collapse" id="collapseComplaint">
            ...
            <li>
              <a href='<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/organization/complaint/uncompleted.php'; ?>'>Uncompleted
                  <?php if($newComplaint>0){ ?>
...
<?php } ?>
    ...
    <!-- Recurring Invoice -->
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Recurring Ivoice">
          ...
          <ul class="sidenav-second-level collapse" id="collapseRecurringInvoice">
            <li>
              <a href='<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/organization/recurringInvoice/index.php'; ?>'>Create</a>
            </li>
            <li>
              <a href='<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/organization/recurringInvoice/scheduler-list.php'; ?>'>List</a>
            </li>
            <li>
              <a href='<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/organization/recurringInvoice/scheduler-insert.php'; ?>'>Insert</a>
            </li>
          </ul>
        </li>
    <?php } ?>
    ...
    <!-- Bill Payment -->
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Bill Payment" style="background:#343A40">
          <a class="nav-link li-nav-style" href='<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/organization/bill/bill.php'; ?>'>
    ...
    <?php //} ?>
    <!-- Sharing -->
    <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Sharing" style="background:#343A40">
    ...
    <?php if(isset($module[6])){ ?>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Client">
          ...
          <ul class="sidenav-second-level collapse" id="collapseClient">
            <li>
              <a href='<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/organization/client/addClient.php'; ?>'>Add Client</a>
            </li>
            <li>
              <a href='<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/organization/client/viewClient.php'; ?>'>View Client</a>
            </li>
          </ul>
        </li>
    <?php } ?>
     ...
     <?php if(isClient()===true){ ?>
        ...
        <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Request">
          ...
          <ul class="sidenav-second-level collapse" id="collapseRequest">
            <li>
              <a id="COMPLAINT-MAKECOMPLAINT" href='<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/client/complaint/makeComplaint.php'; ?>'>Make Request / Complaint</a>
            </li>
            <li>
              <a  id="COMPLAINT-VIEWCOMPLAINT" href='<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/client/complaint/viewComplaint.php'; ?>'>My Requests / Complaints</a>
            </li>
          </ul>
        </li>
      ...
      <!--<ul class="navbar-nav mr-auto" >
        <li class="nav-item dropdown">
          ...
          <a class="dropdown-item " id="COMPLAINT-MAKECOMPLAINT" href='<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/client/complaint/makeComplaint.php'; ?>'>Make Request / Complaint</a>
          <div class="dropdown-divider"></div>
              <a class="dropdown-item " id="COMPLAINT-VIEWCOMPLAINT" href='<?php echo 'https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/client/complaint/viewComplaint.php'; ?>' >My Requests / Complaints </a>
          </div>
      ...
      <?php if((isOrganization()===true && isAdmin()===false) || (isVendor()===true) ){
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-right" aria-labelledby="messagesDropdown">
            ...
            <div class="dropdown-divider"></div>
            <a class="dropdown-item small" href='<?php echo $pendingTaskUrl  ?>'>View all uncompleted task</a>
          </div>
        </li>
...
function shortcut(){
  ...
  require_once($_SERVER['DOCUMENT_ROOT'].$config['appRoot']."/phpfunctions/clientComplaint.php");
  $newComplaint=noOfNewComplaint();
  //<button type='button' class='navbar-toggle' data-toggle='collapse' data-target='#myNavbar' style='cursor: context-menu; background:#343A40; border: 0px; border-radius: 15px; height: 25px; width: 25px;'><div style='background:white; margin: auto; border-radius: 10px; height: 10px; width: 10px;'>
  $shortcut ="
...
<div class='collapse navbar-collapse' id='myNavbar'>
  ...
  <div class='col-md-12'><center>
      ...
      <a href = 'https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/organization/client/addClient.php' class='fa fa-user' style='color:white; font-size:15px; '></a><a style='font-size:12px' href = 'https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/organization/client/addClient.php'>
      ...
      <div id='div2' class='nav-item col-md-2' style='background:#343A40;border:0px; height: 35px; margin-bottom:10px;'>
        <a href = 'https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/organization/vendor/addVendor.php' class='fa fa fa-user' style='color:white; font-size:15px; '></a><a style='font-size:12px' href = 'https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/organization/vendor/addVendor.php'>
      ...
      <div id='div3' class='nav-item col-md-2' style='background:#343A40;border:0px; height: 35px; margin-bottom:10px;'>
        <a href = 'https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/organization/staff/addStaff.php' class='fa fa fa-user' style='color:white; font-size:15px;'></a><a style='font-size:12px' href = 'https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/organization/staff/addStaff.php'>
        Add Staff <i class='fa fa-plus-square' style='color:white; font-size: 1.0em;'></i></a></div>

      <div id='div3' class='nav-item col-md-2' style='background:#343A40;border:0px; height: 35px; margin-bottom:10px;'>
      <a href = 'https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/organization/complaint/uncompleted.php' class='fa fa-comment' style='color:white; font-size:15px; '></a><a style='font-size:12px' href = 'https://".$_SERVER['HTTP_HOST'].$config['appRoot']."/organization/complaint/uncompleted.php'>
      Complaints <i class='badge badge-primary' style='color:white;'></i>".$newComplaint."</span></a></div></center>
  </div>
  <ul>
</div>
