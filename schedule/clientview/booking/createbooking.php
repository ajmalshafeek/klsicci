...
<div class="container-fluid">
    <span id="pageTitleBlock" class="d-block p-3 bg-primary ">New Booking</span>  
    <br/>
        <div id="cleanto" class="direct-load" data-url=<?php echo '"https://'.$_SERVER['HTTP_HOST'].$config['appRoot'].'/cleanto/custom_clientCalendar.php"' ?>></div>
